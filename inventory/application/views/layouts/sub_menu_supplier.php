...
<li ><a href="<?php echo base_url();?>suppliers/supplier_general_settings/<?php echo $supplier_id;?>" class="<?php echo ($active_tab == 'general_settings')?"active1":"";?>">General Settings</a></li>
<?php /*?><li><a href="<?php echo base_url();?>suppliers/payments/<?php echo $supplier_id;?>" class="<?php echo ($active_tab == 'payments')?"active1":"";?>">Payments</a></li><?php */?>
<li><a href="<?php echo base_url();?>suppliers/transactions/<?php echo $supplier_id;?>" class="<?php echo ($active_tab == 'transactions')?"active1":"";?>">Transactions</a></li>
<li><a href="<?php echo base_url();?>suppliers/graph/<?php echo $supplier_id;?>" class="<?php echo ($active_tab == 'graph')?"active1":"";?>">Graph</a></li>
<li><a href="<?php echo base_url();?>suppliers/outstanding_report/<?php echo $supplier_id;?>" class="<?php echo ($active_tab == 'outstanding')?"active1":"";?>">Outstanding</a></li>
