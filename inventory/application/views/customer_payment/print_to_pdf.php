...
<body>
    ...
    <?php
			...
			echo "<div class='heading'>Payment Report &nbsp;&nbsp;&nbsp;".date('d-m-Y')."</div>";
            echo "<table cellpadding='0' cellspacing='0'  align='center' width='100%'>";
            echo "<tr><th  width='25%' class='sub_head'>Name</th><th class='sub_head' width='10%'>Payment Date</th><th class='sub_head' width='10%'>Amount</th><th class='sub_head' width='10%'>User Type</th><th class='sub_head' width='10%'>Status</th></tr>";
			if(!empty($payments_list))
			{
                foreach($payments_list as $list)
                {
                     
                    echo "<tr><td align='center' class='td_height' width='25%'>".ucfirst($list['user_name'])."</td><td align='center' width='10%'>".date('d-m-Y',strtotime($list['payment_date']))."</td><td align='center' width='10%'>".$list['amount']."</td><td align='center' width='10%'>".ucfirst($list['user_type'])."</td><td align='center' width='10%'>".ucfirst($list['status'])."</td></tr>";	  
                }
				echo "</table>";
