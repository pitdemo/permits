    ...
    <div id="page-content" class="clearfix"> 
      ...
      <div class="row-fluid"> 
        ...
        <!-- purchase history table -->
          ...
          <div class="table-header">sales-person-name : <?php echo ucfirst($details['sales_person_name']);?> 
          <span style="float:right">Item-name : <?php echo ucfirst($details['item_name']); ?>&nbsp;&nbsp;</span></div>
...
<script type="text/javascript">
          ...
          $('#table_report').dataTable( {
					...
					"ajax": {
								 ...
								 "url" : '<?php echo base_url();?>sales_month/ajax_customer_history/sales_person_id/<?php echo $get['chk_sales_id']; ?>/item_id/<?php echo $get['chk_item_id']; ?>/sales_date/<?php echo $get['chk_sales_date']; ?>/start/<?php echo $get['chk_start_date']; ?>/end/<?php echo $get['chk_end_date']; ?>',
