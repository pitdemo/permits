  ...
  <div id="main-content" class="clearfix">
    <div id="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="active">Edit Purchase Details</li>
      </ul>
      <!--.breadcrumb-->
    ...
    <div id="page-content" class="clearfix"> 
      ...
      <div class="row-fluid"> 
        ...
        <div class="row-fluid">
          ...
          <div class="row-fluid"> 
            <!--PAGE CONTENT BEGINS HERE-->
            <form class="form-horizontal" action="" method="post" name="purchase_form" id="purchase_form">
                    ...
                    <select name="user_id" id="user_id" style="width:220px">
                       <?php
                        ...
                        if(!empty($suppliers))
                        {
                            ...
                            {
                                $selected_opt='';
                                if($purchase_details['user_type']=='supplier') // set selected option code based on user type
                                {
                                    if($purchase_details['user_id']==$supplier['id'])
                        ...
                        if(!empty($customers))
                        {
                            ...
                            {
                                $selected_opt='';
                                if($purchase_details['user_type']=='customer') // set selected option code based on user type
                                {
                                    if($purchase_details['user_id']==$customer['id'])
                                        $selected_opt = "selected='selected'";
                                } // end
				   ...
				   <select name="item_id" id="item_id" style="width:220px">
                       <?php
                        if(!empty($items))
                        {
                            ...
                            {
                        ?>
                           <option value="<?php echo $item['id']; ?>" <?php echo  (set_value('item_id',(isset($purchase_details['item_id']))?$purchase_details['item_id']:'') == $item['id'])?'SELECTED':''; ?>><?php echo $item['item_code'].'-'.$item['item_name']; ?></option>
                        <?php
                            }
                        }
            ...
            <div class="control-group">
      		    <label class="control-label" for="form-field-1">Purchase date<sup>*</sup></label>
                <div class="controls">
				   <input type="text"  name="purchase_date" id="purchase_date" class="purchase_entry_date" placeholder="Purchase date" readonly="readonly" value="<?php echo set_value('purchase_date',isset($purchase_details['purchase_date'])? $purchase_details['purchase_date'] : ''); ?>" >
            ...
            <div class="control-group">
                ...
                <div class="controls">
				   <input type="text"  name="qty" id="qty" class="qtyNumeric" placeholder="Quantity" value="<?php echo set_value('qty',isset($purchase_details['qty'])? $purchase_details['qty'] : ''); ?>" >
            ...
            <div class="control-group">
                ...
                <div class="controls">
				   <input type="text"  name="amount" id="amount" class="amount_box" placeholder="Amount" value="<?php echo set_value('amount',isset($purchase_details['amount'])? $purchase_details['amount'] : ''); ?>" >
      ...
      <button class="btn" type="reset" onClick="window.location.href='<?php echo base_url();?>purchases'"> Cancel </button>
      </div>
      </div>
		...
		<script type="text/javascript">
				$(document).ready(function(){
                   ...
                   // amount conversion script code
					...
					var validator = $("#purchase_form").validate({
