...
<div class="container-fluid" id="main-container"> <a id="menu-toggler" href="#"> <span></span> </a>
  ...
  <button class="btn btn-info" style="float:right; margin-left:10px; margin-bottom:10px;" onClick="window.location.href='<?php echo base_url();?>purchases/purchase_entry'" type="button">+ Create</button>       <?php } ?>
          ...
          <div class="table-outer">
          	 <table id="table_report" class="table table-striped table-bordered table-hover">
                  <thead>
                    ...
                    <th class="center" width="10%">Purchase Date</th>
                    <th class="center" width="10%">Qty</th>
                    <th class="center" width="15%">Amt</th>
...
<script src="<?php echo base_url();?>js/numeral.min.js" type="text/javascript"></script> 
...
$('#table_report').dataTable( 
{
	...
	"serverSide": true,
	"aaSorting": [[ 0, "desc" ]],	
	"ajax": {url :"<?php echo base_url()?>purchases/datafetch/<?php echo $uri_data;?>",type: "post"},
	"columns": 
	[
		...
		},
		{
			"mRender":function(data,type,full)
			{
				var dateAr = full['purchase_date'].split('-');
