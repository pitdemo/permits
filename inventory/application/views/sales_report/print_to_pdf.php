...
<body>
    ...
    <?php
            ...
            echo "<tr><th  class='sub_head' width='25%'>Item Name</th><th class='sub_head' width='10%'>Sales Date</th><th class='sub_head' width='10%'>Quantity</th><th class='sub_head' width='10%'>Amount</th></tr>";
			if(!empty($sales_list))
			{
                foreach($sales_list as $list)
                {
                     
                    echo "<tr><td align='center' width='25%'>".ucfirst($list['item_name'])."</td><td align='center' width='10%'>".date('d-m-Y',strtotime($list['sales_date']))."</td><td align='center' width='10%'>".$list['qty']."</td><td align='center' width='10%'>".$list['amount']."</td></tr>";	  
                }
				echo "</table>";
