    ...
    <div id="page-content" class="clearfix"> 
      ...
      <div class="row-fluid"> 
        <!--PAGE CONTENT BEGINS HERE-->
          <form name="expense_form" id="expense_form" method="post">
        ...
        <br>
            ...
            <?php if($this->session->userdata('session_user_type')!='viewer'){?>
         <button class="btn btn-info" style="float:right; margin-left:10px; margin-bottom:10px;" onClick="window.location.href='<?php echo base_url();?>expenses/expenses_entry'" type="button">+ Expenses Entry</button>
        <?php } ?>
  
        
            <button class="btn btn-info" style="float:right; margin-left:10px; margin-bottom:10px;" onClick="window.location.href='<?php echo base_url();?>expenses/category_list'" type="button">+ Expenses Category List</button>
                  ...
                  <thead>
                    <tr>
                        <th class="center" width="25%">Expense Category</th>
                         <th class="center" width="15%">Expense Date</th>
                         <th class="center" width="10%">Amount</th>
                         <th class="center" width="10%">Description</th>
...
alert(oSettings);
            ...
            $('.end_date').datetimepicker(
				...
				//start
					...
					"ajax": {
								 "url" : '<?php echo base_url();?>expenses/ajax_get_expenses_list/<?php echo $url; ?>',
           ...
           function chk_search() // manual search function
	       {
		      var frm = document.expense_form;
               if(frm.status.value == "" && frm.start_date.value == "" && frm.end_date.value == "")
                {
        ...
        function export_csv() // download csv document
        {
             var frm = document.expense_form;
                ...
                var url = $("#base_url").val()+"/ajax_get_expenses_list/option_type/csv"+search_url;
               	window.open(url);
        }
