...
<div class="container-fluid" id="main-container"> <a id="menu-toggler" href="#"> <span></span> </a>
  ...
  <div id="main-content" class="clearfix">
    <div id="breadcrumbs">
      <ul class="breadcrumb">
      	 <li>
            <a href="<?php echo base_url();?>suppliers">Manage Customer Payments</a>
...
<span class="notes">Allowed File Types : csv.&nbsp;</span>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>uploads/payments/payments.csv">Click</a> here to download sample file.
</div>
