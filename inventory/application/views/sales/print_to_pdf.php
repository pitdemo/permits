...
<body>
    ...
    <?php
            ...
            echo "<tr><th  width='25%' class='sub_head'>Name</th><th  class='sub_head' width='25%'>Item Name</th><th class='sub_head' width='10%'>Sales Date</th><th class='sub_head' width='10%'>Quantity</th><th class='sub_head' width='10%'>Amount</th><th class='sub_head' width='10%'>User Type</th><th class='sub_head' width='10%'>Remarks</th><th class='sub_head' width='10%'>Status</th></tr>";
					}
                     
                    echo "<tr><td align='center' class='td_height' width='25%'>".ucfirst($list['user_name'])."</td><td align='center' width='25%'>".ucfirst($list['item_name'])."</td><td align='center' width='10%'>".date('d-m-Y',strtotime($list['sales_date']))."</td><td align='center' width='10%'>".$list['qty']."</td><td align='center' width='10%'>".$list['amount']."</td><td align='center' width='10%'>".ucfirst($list['user_type'])."</td><td align='center' width='10%'>".$list['remarks']."</td><td align='center' width='10%'>".ucfirst($list['status'])."</td></tr>";
