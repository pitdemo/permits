    ...
    <div id="page-content" class="clearfix"> 
     <div class="alert alert-warning" style="width:500px;margin:0 auto">
          <span style="font-size:18px"><b>Tips</b></span>
            ...
            <ul>
            <li>The customer-id is unique and auto generated by system based on the customer. </li>
            <li>You can upload bulk customer details through csv file.</li>
            <li>When you click on the names in the column "Name" you will be able to view the customer informations like "General settings","Transactions","Sales" and "Purchases"</li>
            </ul>
            </span></div>
...
<script type="text/javascript">
			$(function() {
				var url = "<?php echo base_url();?>customers/ajax_get_customers/";  // data tables to load bluk records using ajax
								    ...
								    },
								  {
											"fnCreatedCell": function(nTd, sData, oData, iRow, iCol)
												...
												"mRender": function (data,type,full) {                          
								 					//	return data.substr(0, 1).toUpperCase() + data.substr(1);
														return '<a href="<?php echo base_url()?>customers/customer_general_settings/'+btoa(full[5])+'" target="_blank">'+ data.substr(0, 1).toUpperCase() + data.substr(1)+'</a>';
												}
											},
										{
											"fnCreatedCell": function(nTd, sData, oData, iRow, iCol)
											...
											},
										{
											...
											}, 
											{
												...
												"mRender": function (data,type,full) { 
								 								return '	<div class="btn-group"><a href="<?php echo base_url()?>customers/edit_customer/'+btoa(full[5])+'" class="btn btn-mini btn-info" type="button" title="Edit"><i class="icon-edit bigger-120"></i></a><button type="button" class="btn btn-mini btn-danger" onClick="delete_item('+full[5]+',this)" title="Delete"><i class="icon-trash bigger-120"></i></button></div>';
														}
											}, <?php } ?>
             ],
