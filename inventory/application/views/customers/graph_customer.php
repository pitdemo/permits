...
?>
 <head>
		...
		$(document).ready(function() {
	        ...
	        $.getJSON("<?php echo base_url();?>customers/ajax_get_customer_graph/<?php echo $customer_id;?>/<?php echo $url; ?>", function(json) {
  ...
  <div id="main-content" class="clearfix">
    <div id="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="active">Customer Graph Info</li>
	  ...
	  $('.btn').hide();
			...
			function chk_search() // manual search function
	       {
		      ...
		      else
		      {
			   ...
			   window.location.href= $("#base_url").val()+"/graph/" + customer_id +url;
