        ...
        <div class="row-fluid">
          ...
          <div class="row-fluid"> 
                        ...
                        if(!empty($sales_persons))
                        {
                            ...
                            foreach($sales_persons as $sales_person)
                            {
                                $selected_opt='';
                                    ...
                                    if($customer_details['sales_person_id']==$sales_person['id'])
            ...
            <div class="control-group">
                ...
                <div class="controls">
      													<input type="text" placeholder="Customer name" value="<?php echo set_value('customer_name',$customer_details['customer_name']); ?>" name="customer_name" id="customer_name" >
            ...
            <div class="control-group">
                ...
                <div class="controls">
      													<input type="text" placeholder="Email address" value="<?php echo set_value('email_id',$customer_details['email_id']); ?>" name="email_id" id="email_id" >
            ...
            <div class="control-group">
                ...
                <div class="controls">
      													<textarea name="address" id="address" rows="5"><?php echo set_value('address',strip_tags($customer_details['address'])); ?></textarea>
