        ...
        <div class="row-fluid">
          ...
          <div class="row-fluid"> 
            ...
            <div class="control-group">
                ...
                <div class="controls">
      		         <input type="text" placeholder="Customer name" value="<?php echo set_value('customers'); ?>" name="customers[]" id="customers" >
                    <?php echo form_error('customers');?>
                </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
<!--      		         <input type="text" placeholder="Expense Description" value="<?php echo set_value('cus_add'); ?>" name="cus_add[]" id="cus_add0" >-->
                     <textarea placeholder="Address" value="<?php echo set_value('cus_add'); ?>" name="cus_add[]" id="cus_add0" rows="2"></textarea>
		...
		<script type="text/javascript">
				$(document).ready(function(){
                            ...
                            if(x < max_fields){ //max input box allowed
                                ...
                                $("#persons"+i+"").select2({
									...
									placeholder: "- - Select - - ",
									 ...
									 multiple:false,
									  ajax: { 
											url: "<?php echo  base_url(); ?>customers/ajax_get_active_salesperson/",
											dataType: 'json',
											cache: true,
   									quietMillis: 200,
	               ...
	               $("#expense_form" ).submit(function( event ) {
                      var date_err=phone_err=persons_err=customers_err=email_ids_err=0;
                      var err_msg='';
...
*/
				...
				/*					//validate Description
                    ...
                    if(date_err==0&&phone_err==0&&persons_err==0&&customers_err==0&&email_ids_err==0)
			         {
