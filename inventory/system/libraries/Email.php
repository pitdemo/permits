...
class CI_Email {
	...
	var	$smtp_host		= "smtp.mailgun.org";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "galaxygit@dev.galaxyweblinks.com";		// SMTP Username
	var	$smtp_pass		= "HaveANiceDay015";		// SMTP Password
