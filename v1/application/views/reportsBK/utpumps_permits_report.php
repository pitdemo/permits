            ...
            <div class="right-side strech">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active"><a href="javascript:void(0);">UTP Reports</a></li>
                            </ul>
                ...
                <div class="panel-body">
                   ...
                   <th data-field='time_diff' class="center" data-sortable="true" width="75px">Expire within</th>
                               ...
                               <a href="javascript:void(0)" tableexport-id="<?php echo $status; ?>_table" tableexport-filename="UTPUMP Permit Report" class="btn btn-success export_csv">Export to XLS</a> 
                               <a data-url="<?php echo base_url().$controller; ?>ajax_change_status" data-table="<?php echo UTPUMPSPERMITS; ?>" data-table-id="<?php echo $status; ?>_table"  data-modal-class="modal-danger" data-button-class="btn btn-danger" class="btn btn-danger change_reports_status">Self Cancel</a> 
                                    </div>
                                  <?php
								  }
								  ?>
