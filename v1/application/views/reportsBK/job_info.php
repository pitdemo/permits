...
input[type="text"],select,input[type="radio"],input[type="checkbox"] { pointer-events:none !important; }
</style>
                  ...
                  if($approval_status!=4)
                  {
                    ...
                    if(strtolower($status)=='extended')
                    {
                      ...
                      for($r=0;$r<count($range);$r++)
                      {
                        ...
                        #echo '<pre>'; print_r($performing_authority); print_r($issuing_authority_approval_status); exit;
                        #echo '<br /> A '.$performing_authority->$range[$r].' - == '.$user_id.' && '. $issuing_authority_approval_status->$range[$r]; exit;
...
function generate_time2($array_args)
{
  extract($array_args);
   ...
   // text_to_label();
    ...
    function text_to_label()
    {
              ...
              if($(this).val().length>0)
              {
                var originalForm = $('#'+$(this).attr('id'));
                  var div = $('<div/>',{
                       ...
                       id : originalForm.attr('id')+'_label', 
                       class: 'text_bold'
                    });
                   <!-- $('#'+$(this).attr('id')).replaceWith(div); -->
                   $('#'+$(this).attr('id')).css('display','none');
                   $('#'+$(this).attr('id')).after(div);
              }
          });   
      ...
      $select_box_inputs.each(function()
      {
        ...
        console.log(' Dropdown name & Val '+$(this).attr('name')+' = '+$(this).attr('id')+' = = '+$(this).val());
        ...
        if($(this).val() != '')
        {
          var originalFormSelect = $('#'+$(this).attr('id'));
            var select_div = $('<div/>',{
                 ...
                 id : originalFormSelect.attr('id')+'_label',
                 class: 'text_bold'
              });
             <!-- $('#'+$(this).attr('id')).replaceWith(select_div); -->
            $('#'+$(this).attr('id')).css('display','none');
            $('#'+$(this).attr('id')).after(select_div);
        }          
      });
    }   
...
<style>input[type="text"],select,input[type="radio"],input[type="checkbox"] { pointer-events:none !important; background:#F5F5F5; }</style>