<?php $this->load->view('layouts/header',array('page_name'=>'Open Permits')); ?>
<style>
    .label:hover{
        ...
        <div class="panel-body">
          ...
          <div id="no-more-tables" class="overflow768">
					...
					<div class="row">    
                               ...
                               <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6">
								...
								<div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
									...
									?>
                                    <option value="<?php echo $id;?>" ><?php echo $list['name'];?></option>
                                    <?php }} ?>
                                </select>         
                                                              </div>
                                                      </div>
			                        	...
			                        	<button type="button" class="btn btn1 open_permits" ><i class="fa fa-search"></i> Search</button> 
			                    </div>
                                    </div>
                     </div>                      
                </form>     
                  ...
                  <table class="table datatable custom-table table-striped select-all" id="search_table"
                                     ...
                                     data-export-options='{"fileName": "open_permits_report"}'
