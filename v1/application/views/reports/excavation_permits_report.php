            ...
            <div class="right-side strech">
                <section class="content">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="active"><a href="javascript:void(0);">Excavation Reports</a></li>
                            </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <?php $this->load->view('layouts/msg');   $status_arr=array('PA'=>'Performing Authority','IA'=>'Issuing Authority','dept'=>'Dept Clearance','all'=>'All'); $active=''; ?>
                ...
                <div class="panel-body">
                        ...
                        <?php
      								  ...
      								  $job_approvals=unserialize(EXCAVATION_JOBAPPROVALS);
...
<a href="javascript:void(0)" tableexport-id="<?php echo $status; ?>_table" tableexport-filename="Excavation Permit Report" class="btn btn-success export_csv">Export to XLS</a>
<a data-url="<?php echo base_url().$controller; ?>ajax_change_status" data-table="<?php echo EXCAVATIONPERMITS; ?>" data-table-id="<?php echo $status; ?>_table"  data-modal-class="modal-danger" data-button-class="btn btn-danger" class="btn btn-danger change_reports_status">Self Cancel</a> 
                                    </div>
                                  <?php
								  }
								  ?>
