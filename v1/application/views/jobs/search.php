                  ...
                  <form role="form" id="form" name="form" method="post">
                        <div class="row row-cards">
                            <div class="col-12">  
                                ...
                                <button class="form-control search_data" type="button" data-form-name="form" data-params="<?php echo $ajax_paging_params; ?>"><i class="fa fa-search"></i> <span class="text-hidden">Search</span></button>
                                </div>
                        </div>
                            </div>
                        </div>
                          ...
                          <div class="card">
                                ...
                                <div class="row">
                                      <div class="col-sm-12" style="margin-left:5px;">
                                              ...
                                              <a href="javascript:void(0)" tableexport-id="table" tableexport-filename="Open Search Report" class="btn btn-success export_csv">Export</a>
                                              </div>
                                      </div>
                                </div>
                          </div>
