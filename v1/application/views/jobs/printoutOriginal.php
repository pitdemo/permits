...
<body>';
    ...
    $table.='<table align="center" width="100%"  style="font-family:Arial, Helvetica, sans-serif;width:100%;font-size:12px !important; margin:0 auto;border-collapse:collapse;"><tr>
    	...
    	<td align="left"  style="'.$td_border.'"  width="15%" ><b>Contractor:</b></td>
    	<td align="left"  style="'.$td_border.'"  width="15%" ><b>Sub Contractor:</b></td></tr>';


	$table.='<tr>
		<td align="left" style="'.$td_border.'" colspan="3"><b>A) To be filled by Permit Initiator :</b></td>
		<td align="left"   style="'.$td_border.'" colspan="3"><b>Initiator Name & Signature : </b>'.strtoupper($zone_name).'</td>
		</tr>';
	...
	$table.='<tr>
		<td align="left" style="'.$td_border.'" colspan="3"><b>Work Description :</b></td>
		<td align="left"   style="'.$td_border.'" colspan="3"><b>Location : </b>'.strtoupper($zone_name).'</td>
	</tr>';
	...
	$table.='<tr>
		...
		<td align="left"   style="'.$td_border.'">'.$checkbox.'Electrical </td>
		<td align="left" style="'.$td_border.'">'.$checkbox.'Instrumentation </td>
		<td style="'.$td_border.'">'.$checkbox.'Process</td>
    	<td align="left"  style="'.$td_border.'" colspan="2">'.$checkbox.'Civil</td>
    	</tr>';
	...
	$table.='<tr>
		...
		<td align="left" style="'.$td_border.'" colspan="3"><b>Name of the Issuer:</b></td>
	</tr>';
