                                        ...
                                        <label class="control-label labeledit" for="date01">Permit Start Date</label>
                                              <div class="controls">
                                                  <div class="input-group date">
                                                      ...
                                                      <input type="text" class="form-control date-picker" name="subscription_date_start" id="subscription_date_start"  readonly value="<?php echo $subscription_date_start; ?>">
                                                  </div>
                                              </div>
                                        </div>
                                 </div>
                               ...
                               <div class="col-lg-2 col-md-6 col-sm-6 col-xs-6">
                                         <div class="form-group">
                                              ...
                                              <div class="controls">
                                                  <div class="input-group date">
                                                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                      <input type="text" class="form-control date-picker" name="subscription_date_end" id="subscription_date_end" readonly value="<?php echo $subscription_date_end; ?>">
                                                  </div>
                                              </div>
                                         </div>
                                 </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="col-lg-1 col-md-6 col-sm-6 col-xs-6 full-width">
                                      <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn1 search" data-url="department_wise" ><i class="fa fa-search"></i> Search</button> 
                                      </div>
                                </div>
                     </div>   
