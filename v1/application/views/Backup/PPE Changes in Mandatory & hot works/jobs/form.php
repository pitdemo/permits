...
#echo  $user_id.' = '.$cancellation_issuing_id.' - '.$form3_button_name; exit;
                      ...
                      $this->load->view('jobs/print_options',array('record_id'=>$record_id)); ?>
                        ...
                        <div class="col-sm-6 col-md-2">
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control numinput" placeholder="" name="no_of_workers" id="no_of_workers"  value="<?php echo (isset($records['no_of_workers'])) ? $records['no_of_workers'] :  ''; ?>">
                          </div>
                        </div>
                                  ...
                                  <div class="row g-5 completion" style="display:<?php echo (in_array($approval_status,array(WAITING_IA_COMPLETION,WAITING_IA_CANCELLATION,APPROVED_IA_CANCELLATION,APPROVED_IA_COMPLETION))) ? 'block' : 'none'; ?>;">
                                        <div class="col-xl-12">
                                            <div class="row">
                                                  <div class="col-md-6 col-xl-3">
                                                      <div class="mb-3">
                                                          <label class="form-label text-red">PA Work Completion/Cancellation</label>
                                                          <div class="form-control-plaintext">Work completed, all persons are withdrawn and material removed from the area.</div>
                                                      </div>    
                                                  ...
                                                  <div class="col-md-6 col-xl-3">
                                                    <div class="mb-3">
                                                        <label class="form-label text-red">IA Work Completion/Cancellation</label>
                                                    ...
                                                    <div class="col-md-6 col-xl-3">
                                                        <div class="mb-3">
                                                            <label class="form-label text-red">Issuing Authority</label>
                                                                  <div class="mb-3">
                                                                        <label class="form-label">Name of the Issuer</label>
                                                                        <input type="hidden" name="cancellation_issuing_id" id="cancellation_issuing_id"  class="select2dropdown form-control" value="<?php echo $cancellation_issuing_id; ?>"  data-type="issuing_id" data-account-text="<?php echo $cancellation_issuing_name; ?>" data-account-number="<?php echo $cancellation_issuing_id; ?>" data-width="300px" data-filter-value="<?php echo (isset($records['department_id'])) ? $records['department_id'] : $department['id']; ?>" data-skip-users="<?php echo $record_id=='' ? $user_id : $acceptance_performance_id; ?>" />
                                                                        </div>
                                                                        <div class="mb-3">
