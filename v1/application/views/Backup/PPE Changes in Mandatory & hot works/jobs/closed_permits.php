                        ...
                        <?php $this->load->view('layouts/msg'); ?>
                          <div class="card">
                                <table class="table custom-table table-striped table-responsive" id="table"
                                          data-toggle="table"
                                            data-url="<?php echo base_url().$this->data['controller']; ?>ajax_fetch_closeddata/show_button/show/<?php echo (isset($params_url)) ? $params_url : ''; ?>"
                                  ...
                                  <thead>
                                    <tr>
                                      ...
                                      <th data-field='location_time_start' width="210px" data-sortable="true">Start Date</th>
                                      <th data-field='location_time_to' width="210px" data-sortable="true">End Date</th>
