<?php $this->load->view('layouts/header',array('page_name'=>'Permits')); ?>
<style>
    .label:hover{
        ...
        <div class="panel-body">
          ...
          <div id="no-more-tables" class="overflow768">
          		...
          		<form name="filter_form" id="filter_form">
					...
					#print_r($selected_permit_status); exit;
					
					#print_r($selected_zones); exit;
					?>
					<div class="row">    
                     ...
                     <div class="row">    
								...
								#	$work_types = array_merge($work_types,unserialize(CLOSED_PERMITS));
                                    ...
                                    <?php } ?>
			                        	...
			                        	<button type="button" class="btn btn1 permit_search" ><i class="fa fa-search"></i> Search</button> 
			                    </div>
                                    </div>
                     </div>                  
                </form>     
                  ...
                  <table class="table datatable custom-table table-striped select-all" id="search_table"
                                     ...
                                     data-export-options='{"fileName": "permits_report"}'
                          ...
                          <thead>
                                    <tr>
                                          ...
                                          <th data-field='waiating_approval_by' class="center" width="75px">Waiting Approval / Last Approved By</th>
                                          	<th data-field='time_diff' class="center" width="75px">Expire within</th>
                                           <th data-field='status' class="center" width="75px">Approval Status</th>
