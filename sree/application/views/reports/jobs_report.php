                ...
                <div class="panel-body">
                        ...
                        <?php
                                    ...
                                    <div class="tab-pane <?php echo $active; ?>" id="<?php echo $status; ?>">
                                    	...
                                    	<?php $this->load->view('layouts/reports_filter_options',array('status'=>$status,'job_approvals'=>$job_approvals,'is_flammable'=>'yes')); ?>                                       
                                  ...
                                  <thead>
                                    <tr>
                                      <th data-field='chk_box' width="20px;" class="bg-img-none" align="center" ><input type="checkbox" name="checkbox1"  class='bulk_action'></th>
                                       ...
                                       <th data-field='other_inputs_text' width="210px" data-sortable="true">Peptalk</th>
                             ...
                             <a href="javascript:void(0)" tableexport-id="<?php echo $status; ?>_table" tableexport-filename="Combined Permit Report" class="btn btn-success export_csv">Export to XLS</a>

                             <a data-url="<?php echo base_url().$controller; ?>ajax_change_status" data-table="<?php echo JOBS; ?>" data-table-id="<?php echo $status; ?>_table"  data-modal-class="modal-danger" data-button-class="btn btn-danger" class="btn btn-danger change_reports_status">Self Cancel</a>
                                    </div>
                                  <?php
								  }
								  ?>
