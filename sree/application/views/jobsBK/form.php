...
span.error{
  ...
  .issuing_authority { margin-top: 10px; }
 ...
 ?>
  ...
  border-left:none;width:247pt'>a) Standard &amp; certified Scaffold provided <br />
                <input type="text" class="form-control" name="precautions_text[a]" id="precautions_text[a]" value="<?php echo (isset($precautions_text->a)) ? $precautions_text->a : ''; ?>" <?php echo $pre_text_disabled; ?> />                               
                            ...
                            <td class=xl74 style='border-top:none;border-left:none;width:89pt'><center>
                              <input data-attr="a" name="precautions[a]"  <?php if(isset($precautions->a) && $precautions->a=='Yes') { ?> checked="checked" <?php } ?> value="Yes" type="radio" class="radio_button precautions scaffolding_text"/>
                              Y&nbsp;
                              <input data-attr="a" type="radio" <?php if(isset($precautions->a) && $precautions->a=='N/A') { ?> checked="checked" <?php } ?> name="precautions[a]" class="radio_button precautions scaffolding_text" value="N/A" />
                              N/A&nbsp;
                            </center></td>
                          </tr>
                          <?php
  ...
  width:300pt'><b>Nature of Job:</b>&nbsp;
              ...
              $pre_text_disabled='';              
               ...
               <?php if(in_array('Certification of Scaffolds',$pre_options)) { ?> checked="checked" <?php } if($pre_e=='N/A') { ?> disabled="disabled" <?php } ?> value="Certification of Scaffolds" class="radio_button precautions_options" /> <label for="Certification of Scaffolds">Certification of Scaffolds</label> <input type="checkbox" name="precautions_options[e]" data-attr="e" <?php if(in_array('Cranes',$pre_options)) { ?> checked="checked" <?php } if($pre_e=='N/A') { ?> disabled="disabled" <?php } ?> value="Cranes" class="radio_button precautions_options" id="Cranes"/> <label for="Cranes">Cranes</label> <input type="checkbox" name="precautions_options[e]" data-attr="e" <?php if(in_array('lifting eqpt. & tackles ensured & visual inspection done',$pre_options)) { ?> checked="checked" <?php } if($pre_e=='N/A') { ?> disabled="disabled" <?php } ?> value="lifting eqpt. &amp; tackles ensured &amp; visual inspection done" id="lifting eqpt. &amp; tackles ensured &amp; visual inspection done" class="radio_button precautions_options" /> <label for="lifting eqpt. &amp; tackles ensured &amp; visual inspection done">lifting eqpt. &amp; tackles ensured &amp; visual inspection done</label>&nbsp;<br />
               <input data-checkbox="true" type="checkbox" name="precautions_options[e]" data-attr="e" <?php if(in_array('Certified ladder',$pre_options)) { ?> checked="checked" <?php } ?> value="Certified ladder" class="radio_button precautions_options" id="Certified ladder"/> 
               <label for="Certified ladder">Certified ladder</label><br />
                             <input type="text" class="form-control" name="precautions_text[e]" id="precautions_text[e]" value="<?php echo (isset($precautions_text->e)) ? $precautions_text->e : ''; ?>" <?php echo $pre_text_disabled; ?> />
                            ...
                            ?>
                              ...
                              <?php
                                if($record_id!='')
                                {
                                    ...
                                    ?>
                                                    <option value="<?php echo $eip_id; ?>" <?php echo $chk; ?>>A<?php echo $eip_section.'(#'.$eip_no.')'; ?></option>
                                                   <?php
                                      }
                                    }
                                 }   
...
?>
 ...
 <!--  <input type="checkbox" <?php if(in_array('SOP',$other_inputs)) { ?> checked="checked" <?php } ?> name="other_inputs[]" class="other_inputs" value="SOP"  /> SOP 
  ...
  <br /> <input class="other_inputs"  name="other_inputs[]" <?php if(in_array('Work instructions clearly explained to the all the members',$other_inputs)) { ?> checked="checked" <?php } ?> value="Work instructions clearly explained to the all the members"  type="checkbox" /> Work instructions clearly explained to the all the members in the working Group  -->




  <br />
  <input type="checkbox" checked="checked"   name="other_inputs[]" disabled="disabled" class="other_inputs peptalk" value="Peptalk"  /> Peptalk  
      <span id="peptalk" >
                                    ...
                                    <tr>
                                      <td width="50%">
                                          <table align="center" width="100%">
                                              ...
                                              ?>
                                              <tr>
                                              <td style="border-right:.5pt solid black;border-left:none;height:45px;" width="700px">n) Name of the fire watcher <br /> <input type="text" name="firewatcher" id="firewatcher" class="form-control hot_works" value="<?php echo (isset($records['firewatcher'])) ? $records['firewatcher'] : ''; ?>"  <?php echo $checklist; ?>/> </td>
                                              <td style="border-right:.5pt solid black;border-left:none;" width="100px">
                                      ...
                                      <td width="50%" valign="top">
                                          <table align="center" width="100%">
                                             ...
                                             <?php
                                              ...
                                              ?>
                                              <tr rowspan="2">
                                              <td style="border-right:.5pt solid black;border-left:none;height:40px;" width="700px">&nbsp;</td>
                                              <td style="border-left:none;" width="100px">
                                                &nbsp;
                                                </td>
                                               </tr>
...
<select class="form-control extended_contractors_id contractors" name="extended_contractors_id[e]"  data-show="extended_others_contractors_id_e" style="width:170px;margin-top:10px;" data-attr="e">
  ...
  <select id="issuing_authority[a]" name="issuing_authority[a]"  class="issuing_authority form-control authority issuing" style="width: 145px;padding-top:5px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
...
<br /><p><b>Name of IA</b></p>
 ...
 <input type="text" <?php echo $show_name_of_ia; ?> name="extend_issuing_authority_name_of_ia[a]" id="extend_issuing_authority_name_of_ia[a]" class="form-control" value="<?php echo (isset($extend_issuing_authority_name_of_ia->a)) ? $extend_issuing_authority_name_of_ia->a : ''; ?>"/><br />
                            ...
                            <td colspan=2 class=xl177  style='border-right:1.0pt solid black; border-left:none;'>
...
<tr height=40 style='height:30.0pt'>
  ...
  $issuing_authority_approval_status_b=(isset($issuing_authority_approval_status->b)) ? $issuing_authority_approval_status->b : '';
    ...
    #echo 'fF '.$issuing_authority_b.' = '.$performing_authority_b.' = '.$user_id.' = '.$ref_code_show;
...
<tr height=40 style='height:30.0pt'>
  ...
  height:23.25pt;width:936pt'>
            ...
            $redirect=$ext_name_of_ia=$ext_range=$is_reject=$cancel_ia='';
            ...
            if($is_draft==YES && $user_id!=$draft_user_id)
             ...
             #echo 'A '.$user_id.' == '.$records['acceptance_issuing_id'].' = '.$is_rejected.' = '.$acceptance_issuing_approval.' = '.$approval_status; 
            if($approval_status<9 && $draft==NO && $is_rejected!=YES)
            {
                  ...
                  if($show_flag==2)
                  {
                       ...
                       echo '<button class="btn btn-sm btn-primary show_button" id="submit" value="'.$submit_value.'" type="submit"><i class="fa fa-dot-circle-o"></i> '.$label.'</button>';
                          ...
                          if($eip_opened==count($jobs_isoloations_ids))
                          {
                              ...
                              echo '<button class="btn btn-sm btn-primary show_button" value="hide" id="submit" type="submit"><i class="fa fa-dot-circle-o"></i> Final Submit</button>';
                          }    
                      }
                  }
                }
                else
                {
                  if($approval_status!=4)
                  {
                      ...
                      foreach($range as $ranges)
                      {
                        ...
                        if($issuing_authority->$ranges==$user_id && $issuing_authority_approval_status->$ranges!='Approved'  && $is_rejected==NO)
                        {
                          $is_extended=1; $is_show_extended_button=1; $is_reject=1; 
                            ...
                            if($permission==READ)
                            { $ext_range=$ranges; $ext_name_of_ia=$issuing_authority->$ranges; }
                    ...
                    {
                      $is_reject=1; $cancel_ia=1; $submit_value='show';
            ...
            if($is_reject!=''  && $is_rejected==NO)
              echo '<button class="btn btn-sm btn-danger show_button" id="submitreject" value="reject" type="submit"><i class="fa fa-dot-circle-o"></i> Reject Request</button>';
            ?>
             <a  class="btn btn-sm btn-danger" href="<?php echo $redirect; ?>"><i class="fa fa-ban"> Go Back</i></a>&nbsp;

             <?php if($approval_status<2 && $user_id==$acceptance_performing_id && $is_rejected!=YES) { ?>
            <button class="btn btn-sm btn-info show_button" id="draft"  value="<?php echo $submit_value; ?>" data-submit="0" type="submit"><i class="fa fa-dot-circle-o"></i> Save as Draft</button>
                        <?php }
            if(!empty($record_id))
            {
              if($readonly==false)
...
<script type="text/javascript">   
  ...
  $(document).ready(function() {
    ...
    $('.scaffolding_text').change(function()
    {

        var val=$(this).val();

        var val2=$('input[name="hazards[a]"]:checked').val();

        $('input[name="is_scaffolding_certification"]').attr('disabled',true);

        if(val=='Yes' && val2=='Yes')
        {
            $('input[name="is_scaffolding_certification"]:first').attr('checked',true);

            $('input[name="is_scaffolding_certification"]:first').trigger('change');
        }
        else
        {
            $('input[name="is_scaffolding_certification"]:last').attr('checked',true);

            $('input[name="is_scaffolding_certification"]:last').trigger('change');
            ...
            acceptance_issuing_date=$('#schedule_date'+(d-1)).val();  
                ...
                $( "#schedule_date"+d ).datepicker({
                  ...
                  onSelect: function (date) {
                        ...
                        console.log('Line no : 3045 '+selector_name);
                        ...
                        $('select[name="extended_contractors_id['+selector_name+']"] option:not(:selected),input[name="extended_others_contractors_id['+selector_name+']"] option:not(:selected)').prop('disabled',false);
                        ...
                        $('select[name="schedule_from_time['+selector_name+']"] option:not(:selected),select[name="schedule_to_time['+selector_name+']"] option:not(:selected)').removeAttr('disabled');

                        $('select[name="schedule_from_time['+selector_name+']"],select[name="schedule_to_time['+selector_name+']"]').prop('disabled',false);

                         $('select[name="issuing_authority['+selector_name+']"] option:not(:selected),select[name="performing_authority['+selector_name+']"] option:not(:selected)').removeAttr('disabled');
...
{   
  ...
  if(data_attr=='a')
    $('.scaffolding_text').trigger('change');
...
$('.required_ppe').change(function()
{
  ...
  //alert($(this).attr('data-other'));
   ...
   # $ext_range=$range; $ext_name_of_ia=$issuing_authority->$ranges;
...
$('.contractors').change(function()
{
  ...
  $validate.=",'self_cancellation_description':{required:function(element) {
    ...
    $('#draft').click(function()
    {
           ...
           form.find(".error").removeClass("error").next('label.error').remove();*/
    ...
    $('#submit,#submitreject').click(function()
    {
