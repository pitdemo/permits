...
$table.='<tr align="center">
    ...
    <td style="border:1px solid #ccc;" colspan="3"><strong>Equipment Type</strong></td>
</tr>';
...
$loop_count=10;
 ...
 for($i=1;$i<=$loop_count;$i++)
 {
     ...
     $table.='<tr align="center">
        <td style="border:1px solid #ccc;" colspan="1" align="center">'.$i.'</td>
...
$table.='<tr>
    ...
    <td style="border:1px solid #ccc;" width="" colspan="5" style="border-bottom:1px solid #FFF">Signature : </td>
</tr>';
...
$table.='<tr>
    ...
    <td style="border:1px solid #ccc;" width="" colspan="3">Signature :  </td>
</tr>';
...
$table.='<tr>
    ...
    <th style="border:1px solid #ccc;" colspan="4">LOTO Lock & Tag No</th>
    <th style="border:1px solid #ccc;">Name of Auth Isolator</th>
    <th style="border:1px solid #ccc;">Signature</th>
</tr>';
...
$loop_count=10;
	...
	<td style="border:1px solid #ccc;" align="center">'.strtoupper($iso_tag3).'</td>
	...
	<td style="border:1px solid #ccc;">'.strtoupper($isolated_name_approval_dttime).'</td>
	  </tr>';
	}
	...
	$table.='<tr>
    <td style="border:1px solid #ccc;" width="" colspan="10" id="t2"><strong>(D) To be filled and ensured by the Issusing Authority </strong></td>
</tr>';
$table.='<tr><td style="border:1px solid #ccc;" colspan="1">1</td><td style="border:1px solid #ccc;" colspan="6">Is equipment stopped & Isolated</td><td style="border:1px solid #ccc;" colspan="3" align="center"><input type="radio" disabled name="is_equipment_stopped" class="radio_button on_off" '.$yes_active.' />&nbsp;<input type="radio" disabled name="is_equipment_stopped" class="radio_button on_off" '.$no_active.' />&nbsp;<input type="radio" disabled name="is_equipment_stopped" class="radio_button on_off" '.$na_active.' /></td></tr>';
...
$table.='<tr><td style="border:1px solid #ccc;" colspan="1">3</td><td style="border:1px solid #ccc;" colspan="6">
    ...
    </td><td style="border:1px solid #ccc;" colspan="3" align="center"><input type="radio" disabled name="is_isoloation_drained_fully" class="radio_button on_off" '.$yes_active.' />&nbsp;<input type="radio" disabled name="is_isoloation_drained_fully" class="radio_button on_off" '.$no_active.' />&nbsp;<input type="radio" disabled name="is_isoloation_drained_fully" class="radio_button on_off" '.$na_active.' /></td></tr>';
...
$table.='<td style="border:1px solid #ccc;" colspan="3">
        <table style="width:100%;border:0px !important; border-collapse:collapse;" border="0">
            ...
            <tr><th>Department</th><th>Signature</th></tr>
...
$table.='<tr><td style="border:1px solid #ccc;" colspan="10">Emergency Contact number : Cell : 9865152222/ 3108 / PA system 9 Ref No: WI-33(P1-14:AM 7) Rev No: 01 Dt. 30.06.2016</td></tr>';
$table.='</table>';
