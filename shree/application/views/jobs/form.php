                                              ...
                                              <div class="mb-3">
                                                  <label class="form-label text-red">Name of the Issuer</label>
                                                        <div class="mb-3">
                                                              ...
                                                              <input type="hidden" name="cancellation_issuing_id" id="cancellation_issuing_id"  class="select2groupbydropdown form-control issuers_lists" value="<?php echo $cancellation_issuing_id; ?>"  data-type="<?php echo ($zone_type==NON_PRODUCTION) ? 'custodian_id' : 'issuing_id'; ?>" data-account-text="<?php echo $cancellation_issuing_name; ?>" data-account-number="<?php echo $cancellation_issuing_id; ?>" data-width="300px" data-filter-value="<?php echo (isset($records['department_id'])) ? $records['department_id'] : $department['id']; ?>" data-skip-users="<?php echo $record_id=='' || $records['cancellation_performing_id']=='' ? $user_id : $acceptance_performance_id.','.$records['cancellation_performing_id']; ?>" />
                                                              </div>
                                                              <div class="mb-3">
