                ...
                <div class="tab-content">
                  ...
                  <form id="job_form" name="job_form" enctype="multipart/form-data" > 
                    ...
                    <div class="row g-5">
                        <div class="col-md-3">
                                <div class="mb-3">
                                <span class="form-label text-red"><b>Scaffolding Require</b></span><br />
                                      <?php
                                      $disabled='';
                                      ...
                                      ?>
                                        <label class="form-check form-check-inline">
                                                <input  type="radio" 
                                                name="is_scaffolding" value="<?php echo $val; ?>"  class="form-check-input is_scaffolding" data-id="<?php echo $key; ?>" <?php echo $chk; ?> <?php echo $disabled; ?>><span class="form-check-label"><?php echo $val; ?></span>
                                        </label>
                                      <?php endforeach; ?>
                                </div>
                          </div>
                    ...
                    <div class="row g-5 scaffoldings_sections"  style="display:<?php echo $is_loto==YES ? 'block' : 'none'; ?>">
                      ...
                      <div class="row">
                                <div class="col-xl-12" id="checklists_table" style="display:block" >
                                                <div class="row">
                                                    <div class="col-md-8 col-xl-8"><div class="mb-3">
...
<script>
  ...
  $(".is_scaffolding").change(function()
  {
      var val=$(this).val();      
      ...
      if(loto==1){
        $('.scaffoldings_sections').show(); 
        load_lotos();
      } else{
        $('.scaffoldings_sections').hide(); 
      }
  });
