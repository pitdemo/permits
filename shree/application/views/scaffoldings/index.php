...
<div class="page-wrapper">
          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center" >
              ...
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <a href="<?php echo base_url(); ?>/scaffoldings/form" class="btn btn-primary d-none d-sm-inline-block" >
        ...
        <div class="page-body" style="background-color:white;">
          <div class="container-xl">
                 ...
                 <?php $this->load->view('scaffoldings/search_form',array('ajax_paging_url'=>$ajax_paging_url,'ajax_paging_params'=>$ajax_paging_params)); ?>
                  ...
                  <div class="row row-cards">
                    <?php
                     ...
                     ?>                    
                        <div class="col-auto ms-auto d-print-none">
                         <div class="btn-list">
                           <a href="<?php echo base_url(); ?>/scaffoldings/form/?mode=<?php echo $this->session->userdata('mode'); ?>" class="btn btn-primary" > 
                             Create
                           </a>               
                         </div>
                     </div> <br /><br />
                      ...
                      <div class="col-12">    
                          <div class="card">
                                ...
                                <table class="table custom-table table-striped table-responsive" id="table"
                                  ...
                                  <thead>
                                    <tr>       
                                      <th data-field='scaffolding_id'  class="center" data-sortable="true">Scaffolding ID</th>
                                      <th data-field='location'  width="210px" data-sortable="false">Location</th>                                      
                                      <th data-field='meter' class="center" width="75px">Meter</th>
                                      <th data-field='approval_status' class="center" width="75px"> Status</th>
                                      <th data-field='responsible_persons' class="center" data-sortable="true" width="75px">Responsible Person</th>  
