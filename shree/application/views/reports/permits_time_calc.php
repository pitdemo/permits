<?php $this->load->view('layouts/header',array('page_name'=>'Time Calculation of combined work permits')); ?>
<style>
    .label:hover{
...
<div class="main acccount-con min-height">
  <div class="row mr-none">
    <div class="col-lg-12">
      ...
      <h1>Time Calculation of combined work permits</h1>
        ...
        <div class="panel-body">
          ...
          <div id="no-more-tables" class="overflow768">
                     ...
                     <div class="row">    
								...
								#	$work_types = array_merge($work_types,unserialize(CLOSED_PERMITS));
                                    ...
                                    <?php } ?>
                                                          ...
                                                          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6">
                                                              <div class="form-group">
                                                              <label class="control-label labeledit" for="date01">Permit No</label>
                                                              <div class="controls">
                                    ...
                                    <?php }} ?>
			                        	...
			                        	<button type="button" class="btn btn1 time_calc_permit_search" ><i class="fa fa-search"></i> Search</button> 
			                    </div>
                                    </div>
                     </div>                  
                </form>     
                  ...
                  <table class="table datatable custom-table table-striped select-all" id="search_table"
                                     ...
                                     data-export-options='{"fileName": "permits_time_calc_report"}'
                          ...
                          <thead>
                                    <tr>
                                           ...
                                           <th data-field='acceptance_performing_date' class="center" width="75px">PA App. Date</th>
                                           <th data-field='acceptance_issuing_date' class="center" width="75px">IA App. Date</th>
...
<script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.time_calc_permit_search').trigger('click');
	});
</script>