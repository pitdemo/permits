                        ...
                        <fieldset>
                            <div class="form-group first">
                                <div class="input-group col-sm-12">
                                    ...
                                    <input type="text" class="form-control input-lg" id="email_address" placeholder="Username" name="email_address" autocomplete="off" value="<?php echo set_value('email_address');?>" />  
                                </div>
                            </div>
