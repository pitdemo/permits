...
<div class="wrapper row-offcanvas row-offcanvas-left">
 ...
 ?>
  ...
  width:245pt'>a) <input type="checkbox" name="hazards_options[a]" data-attr="a" <?php if(in_array('Platform',$haz_options)) { ?> checked="checked" <?php } ?> value="Platform" class="radio_button hazards_options" /> No permanent Platform <input  data-attr="a" type="checkbox" name="hazards_options[a]" class="radio_button hazards_options" value="Handrails" <?php if(in_array('Handrails',$haz_options)) { ?>  checked="checked" <?php } ?> /> Handrails <input  data-attr="a" type="checkbox" <?php if(in_array('Stairs',$haz_options)) { ?> checked="checked" <?php } ?> value="Stairs" name="hazards_options[a]" class="hazards_options radio_button" /> Stairs</td>
                            <td class=xl87 width=108 style='border-top:none;border-left:none;width:55pt'><input name="hazards[a]" data-attr="a" data-checkbox='true' type="radio" <?php if(isset($hazards->a) && $hazards->a=='Yes') { ?> checked="checked" <?php } ?> class="radio_button hazards hazard_option" value="Yes" />
                              Y&nbsp;
  ...
  border-left:none;width:247pt'>a) Standard &amp; certified Scaffold provided <br />
								<input type="text" class="form-control" name="precautions_text[a]" id="precautions_text[a]" value="<?php echo (isset($precautions_text->a)) ? $precautions_text->a : ''; ?>" />	                              
  </td>
  ...
  width:245pt'>b) Un Safe Access to work area.</td>
                            ...
                            <td colspan=6 class=xl115 style='border-left:none;width:247pt'>b)
                              ...
                              <input type="text" class="form-control" name="precautions_text[b]" id="precautions_text[b]" value="<?php echo (isset($precautions_text->b)) ? $precautions_text->b : ''; ?>" />
</td>
                            <td class=xl74 style='border-top:none;border-left:none;width:89pt'><center>
  ...
  width:245pt'>c) Falling of material.</td>
                            ...
                            <td colspan=6 class=xl119 style='border-left:none;width:247pt'>c)
                              <input type="checkbox" name="precautions_options[c]" data-attr="c" <?php if(in_array('Loose materials removed & barricade tape',$pre_options)) { ?> checked="checked" <?php } if($pre_c=='N/A') { ?> disabled="disabled" <?php } ?> value="Loose materials removed &amp; barricade tape" class="radio_button precautions_options" /> Loose materials removed &amp; barricade tape <input type="checkbox" name="precautions_options[c]" data-attr="c" <?php if(in_array('Signs provided',$pre_options)) { ?> checked="checked" <?php } if($pre_c=='N/A') { ?> disabled="disabled" <?php } ?>  value="Signs provided" class="radio_button precautions_options" /> Signs provided <br /><input type="text" class="form-control" name="precautions_text[c]" id="precautions_text[c]" value="<?php echo (isset($precautions_text->c)) ? $precautions_text->c : ''; ?>" /></td>
                          ...
                          <tr height=50 style='mso-height-source:userset;height:37.5pt'>
                            <td colspan=4 height=50 class=xl117 style='height:47.5pt;'><b>Equipment name:</b>&nbsp;<br />
                              <input type="text" value="<?php echo (isset($records['equipment_name'])) ? $records['equipment_name'] : ''; ?>" class="form-control" name="equipment_name" id="equipment_name" style="width:400px;" />

                               <!--<select class="form-control select2-offscreen equipment_name" multiple name="equipment_name" id="equipment_name"  style="width:400px; !important;">
                                  ...
                                  ?>
                                    ...
                                    <option value="<?php echo $i; ?>"><?php echo $i.' - Equipment Description'; ?></option>
                                  <?php  
                                  }
                                  ?>
                               </select >-->
  ...
  width:245pt'>d) <input type="checkbox" name="hazards_options[d]" data-checkbox='true' data-attr="d" <?php if(in_array('Electrical Lines',$haz_options)) { ?> checked="checked" <?php } ?> value="Electrical Lines" class="radio_button hazards_options" <?php echo $eip_disabled; ?>/> Over Head Electrical Lines <input <?php echo $eip_disabled; ?> type="checkbox" data-checkbox='true' name="hazards_options[d]" data-attr="d" <?php if(in_array('Electric shock to personnel',$haz_options)) { ?> checked="checked" <?php } ?> value="Electric shock to personnel" class="radio_button hazards_options" /> Electric shock to personnel</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input type="radio"  name="hazards[d]" class="radio_button hazards hazard_option" data-checkbox="true" data-attr="d" value="Yes" <?php if(isset($hazards->d) && $hazards->d=='Yes') { ?> checked="checked" <?php } ?> <?php echo $eip_disabled; ?>/>
                              Y&nbsp;
  ...
  <input type="text" class="form-control" name="precautions_text[d]" id="precautions_text[d]" value="<?php echo (isset($precautions_text->d)) ? $precautions_text->d : ''; ?>" />
  </td>
  ...
  width:300pt'><b>Nature of Job:</b>&nbsp;
                            ...
                            <td colspan=4 class=xl115 style='width:245pt'>e) Failure of
                              <input type="checkbox" data-checkbox="true" name="hazards_options[e]" data-attr="e" <?php if(in_array('Scaffolding',$haz_options)) { ?> checked="checked" <?php } ?> value="Scaffolding" class="radio_button hazards_options" /> Scaffolding <input data-checkbox="true" type="checkbox" name="hazards_options[e]" data-attr="e" <?php if(in_array('Ladders',$haz_options)) { ?> checked="checked" <?php } ?> value="Ladders" class="radio_button hazards_options" /> Ladders <input data-checkbox="true" type="checkbox" name="hazards_options[e]" data-attr="e" <?php if(in_array('Crane',$haz_options)) { ?> checked="checked" <?php } ?> value="Crane" class="radio_button hazards_options" /> Crane <input data-checkbox="true" type="checkbox" name="hazards_options[e]" data-attr="e" <?php if(in_array('Other lifting equipment',$haz_options)) { ?> checked="checked" <?php } ?> value="Other lifting equipment" class="radio_button hazards_options" /> Other lifting equipment</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input data-attr="e" type="radio" class="radio_button hazards hazard_option" data-checkbox='yes' value="Yes" <?php if(isset($hazards->e) && $hazards->e=='Yes') { ?> checked="checked" <?php } ?>  name="hazards[e]" />
                              Y&nbsp;
                            ...
                            e)
							 ...
							 <?php if(in_array('Certification of Scaffolds',$pre_options)) { ?> checked="checked" <?php } if($pre_e=='N/A') { ?> disabled="disabled" <?php } ?> value="Certification of Scaffolds" class="radio_button precautions_options" /> Certification of Scaffolds <input type="checkbox" name="precautions_options[e]" data-attr="e" <?php if(in_array('Cranes',$pre_options)) { ?> checked="checked" <?php } if($pre_e=='N/A') { ?> disabled="disabled" <?php } ?> value="Cranes" class="radio_button precautions_options" /> Cranes <input type="checkbox" name="precautions_options[e]" data-attr="e" <?php if(in_array('lifting eqpt. & tackles ensured & visual inspection done',$pre_options)) { ?> checked="checked" <?php } if($pre_e=='N/A') { ?> disabled="disabled" <?php } ?> value="lifting eqpt. &amp; tackles ensured &amp; visual inspection done" class="radio_button precautions_options" /> lifting eqpt. &amp; tackles ensured &amp; visual inspection done <br />
                             <input type="text" class="form-control" name="precautions_text[e]" id="precautions_text[e]" value="<?php echo (isset($precautions_text->e)) ? $precautions_text->e : ''; ?>" />
                          ...
                          <tr height=73 style='mso-height-source:userset;height:54.75pt'>
                            ...
                            <td colspan=2 valign="top"  class=xl139 style='border-right:1.0pt solid black; border-bottom:1.0pt solid black;width:130pt'><b>No of Persons involved</b>&nbsp;
                              <input type="text"  value="<?php echo (isset($records['contractors_involved'])) ? $records['contractors_involved'] : ''; ?>" name="contractors_involved" id="contractors_involved" class="form-control" style="width:130px;" /></td>
                            <td colspan=4 class=xl115 style='width:245pt'>f) Fall of person
                              from -height</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input data-attr="f" type="radio" class="radio_button hazards"  name="hazards[f]" data-checkbox='true' value="Yes" <?php if(isset($hazards->f) && $hazards->f=='Yes') { ?> checked="checked" <?php } ?> />
                              Y&nbsp;
                            ...
                            f)
							  ...
							  <?php if(in_array('Use of Full Body Harness',$pre_options)) { ?> checked="checked" <?php }  if($pre_f=='N/A') { ?> disabled="disabled" <?php } ?> value="Use of Full Body Harness" class="radio_button precautions_options" /> Use of Full Body Harness <input type="checkbox" name="precautions_options[f]" data-attr="f" <?php if(in_array('Anchor points',$pre_options)) { ?> checked="checked" <?php } if($pre_f=='N/A') { ?> disabled="disabled" <?php } ?> value="Anchor points" class="radio_button precautions_options" /> Anchor points <input type="checkbox" name="precautions_options[f]" data-attr="f" <?php if(in_array('Fall arrestors',$pre_options)) { ?> checked="checked" <?php } if($pre_f=='N/A') { ?> disabled="disabled" <?php } ?> value="Fall arrestors" class="radio_button precautions_options" /> Fall arrestors <input type="checkbox" name="precautions_options[f]" data-attr="f" <?php if(in_array('Safety Nets',$pre_options)) { ?> checked="checked" <?php } if($pre_f=='N/A') { ?> disabled="disabled" <?php } ?> value="Safety Nets" class="radio_button precautions_options" /> Safety Nets 
                              <input type="checkbox" name="precautions_options[f]" data-attr="f" <?php if(in_array('Life lines',$pre_options)) { ?> checked="checked" <?php } if($pre_f=='N/A') { ?> disabled="disabled" <?php } ?> value="Life lines" class="radio_button precautions_options" /> Life lines <input type="checkbox" name="precautions_options[f]" data-attr="f" <?php if(in_array('Vertigo Test Certificate',$pre_options)) { ?> checked="checked" <?php } if($pre_f=='N/A') { ?> disabled="disabled" <?php } ?> value="Vertigo Test Certificate" class="radio_button precautions_options" /> Vertigo Test Certificate
                              ensured as required.<br />
                               <input type="text" class="form-control" name="precautions_text[f]" id="precautions_text[f]" value="<?php echo (isset($precautions_text->f)) ? $precautions_text->f : ''; ?>" />
                              </td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
 ...
 <a class="thickbox" href="<?php echo base_url(); ?>jobs/ajax_show_energy_info/?TB_iframe=true&keepThis=true&width=1050" id="energy_form" title=" Energy Isolation Permit Form" style="visibility:hidden;">Thickbox</a>
  ...
  style='mso-spacerun:yes'> </span>g)After energy isolation, equipment/pipe
                              line fully drained &amp; depressurised/ cleaning of area done.<br />
                               <input type="text" class="form-control" name="precautions_text[g]" id="precautions_text[g]" value="<?php echo (isset($precautions_text->g)) ? $precautions_text->g : ''; ?>" />
                              </td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
  ...
  <?php if(in_array('Danger due to naked flames',$haz_options)) { ?> checked="checked" <?php } ?> value="Danger due to naked flames" class="radio_button hazards_options" /> Danger due to naked flames <input type="checkbox" name="hazards_options[h]" data-attr="h" 
  <?php if(in_array('Ignition of Flammables',$haz_options)) { ?> checked="checked" <?php } ?> value="Ignition of Flammables" class="radio_button hazards_options" /> Ignition of Flammables</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input data-attr="h" type="radio" class="radio_button hazards hazard_option"  name="hazards[h]" data-checkbox="true" value="Yes" <?php if(isset($hazards->h) && $hazards->h=='Yes') { ?> checked="checked" <?php } ?> />
                              Y&nbsp;
                            ...
                            <td colspan=6 class=xl119 style='border-left:none;width:247pt'>h)
                              Space free of Flammables <br /> <input type="text" class="form-control" name="precautions_text[h]" id="precautions_text[h]" value="<?php echo (isset($precautions_text->h)) ? $precautions_text->h : ''; ?>" /></td>
                            <td class=xl75 style='border-top:none;border-left:none;width:89pt'><center>
  ...
  style='mso-spacerun:yes'> </span> */ ?>Using Any Welding/Gas Cutting Sets<br /> <input type="text" class="form-control" name="precautions_text[i]" id="precautions_text[i]" value="<?php echo (isset($precautions_text->i)) ? $precautions_text->i : ''; ?>" /></td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input data-attr="i" type="radio" class="radio_button hazards hazard_option"  name="hazards[i]" value="Yes" <?php if(isset($hazards->i) && $hazards->i=='Yes') { ?> checked="checked" <?php } ?> />
                              Y&nbsp;
  ...
  class="font14">Welding, gas cutting sets checked </font><font class="font12">and
                              Rectified<br /> <input type="text" class="form-control" name="precautions_text[i]" id="precautions_text[i]" value="<?php echo (isset($precautions_text->i)) ? $precautions_text->i : ''; ?>" /></font></td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
  ...
  style='mso-spacerun:yes'>  </span>Fire during work activity</td>
                            ...
                            <input type="checkbox" name="precautions_options[j]" data-attr="j" <?php if(in_array('Adequate protection',$pre_options)) { ?> checked="checked" <?php } if($pre_j=='N/A') { ?> disabled="disabled" <?php } ?> value="Adequate protection" class="radio_button precautions_options" /> Adequate protection <input type="checkbox" name="precautions_options[j]" data-attr="j" <?php if(in_array('Fire extinguisher and Fire blanket available',$pre_options)) { ?> checked="checked" <?php } if($pre_j=='N/A') { ?> disabled="disabled" <?php } ?> value="Fire extinguisher and Fire blanket available" class="radio_button precautions_options" /> Fire extinguisher and Fire blanket available.<br /> <input type="text" class="form-control" name="precautions_text[j]" id="precautions_text[j]" value="<?php echo (isset($precautions_text->j)) ? $precautions_text->j : ''; ?>" /></td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
  ...
  <input type="checkbox" name="hazards_options[k]" data-attr="k" <?php if(in_array('Machinery',$haz_options)) { ?> checked="checked" <?php } ?> value="Machinery" class="radio_button hazards_options" <?php echo $eip_disabled; ?>/> Moving Machinery <input type="checkbox" name="hazards_options[k]" data-attr="k" <?php if(in_array('Electric shock',$haz_options)) { ?> checked="checked" <?php } ?> value="Electric shock" class="radio_button hazards_options" <?php echo $eip_disabled; ?>/> <font class="font12">Electric shock </font><font
  class="font20"><input type="checkbox" name="hazards_options[k]" data-other="hazards_options_k" data-attr="k" 
  <?php if(in_array('Other Energy',$haz_options)) { ?> checked="checked" <?php } ?> value="Other Energy" class="radio_button hazards_options" <?php echo $eip_disabled; ?>/> Other Energy</font>
  				...
  				<span id="hazards_options_k" style="display:none;"><input type="text" name="hazards_other_options[k]" id="hazards_other_options[k]" class="form-control" /></span>
                            ...
                            <td class=xl70><input data-attr="k" type="radio" class="radio_button hazards hazard_option" value="Yes" <?php if(isset($hazards->k) && $hazards->k=='Yes') { ?> checked="checked" <?php } ?> data-checkbox="true"  name="hazards[k]" <?php echo $eip_disabled; ?>/>
                              Y&nbsp;
                            ...
                            <td colspan=6 class=xl119 style='width:247pt'>k) Hazardous Energy Isolation ensured
								<input type="text" class="form-control" name="precautions_text[k]" id="precautions_text[k]" value="<?php echo (isset($precautions_text->k)) ? $precautions_text->k : ''; ?>" />	                              
                            </td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
  ...
  height:24.75pt;width:245pt'>l) Poor ventilation</td>
                            ...
                            <td colspan=6 class=xl195 style='width:247pt'>l) Proper ventilation
                              facilities provided<br /> <input type="text" class="form-control" name="precautions_text[l]" id="precautions_text[l]" value="<?php echo (isset($precautions_text->l)) ? $precautions_text->l : ''; ?>" /></td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
  ...
  width:245pt'>m) Poor Illumination<span style='mso-spacerun:yes'> </span></td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input data-attr="m"  name="hazards[m]" type="radio" class="radio_button hazards" value="Yes" <?php if(isset($hazards->m) && $hazards->m=='Yes') { ?> checked="checked" <?php } ?> />
                              ...
                              N&nbsp;</td>
                            <td colspan=6 class=xl119 style='border-left:none;width:247pt'>m)Adequate<span style='mso-spacerun:yes'>  </span>Illumination<br /> <input type="text" class="form-control" name="precautions_text[m]" id="precautions_text[m]" value="<?php echo (isset($precautions_text->m)) ? $precautions_text->m : ''; ?>" /></td>
                            <td class=xl75 style='border-top:none;width:89pt'><center>
                          ...
                          <tr height=52 style='mso-height-source:userset;height:39.0pt'>
                            ...
                            <?php
                              ...
                              $pre_options = array('Adequate Awareness of emergency procedures','Ensure for clear emergency exits');
                            ...
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'><input data-attr="n" type="radio" checked="checked" disabled="disabled" name="precautions[n]" data-checkbox="yes" value="Yes" class="radio_button precautions"/>
  ...
  ?>
   ...
   ?>
                          ...
                          <tr height=35 style='mso-height-source:userset;height:26.25pt'>
                            <td height=35  colspan="2" width=831 style='height:26.25pt;width:111pt' align=left
  valign=top><span
  ...
  border-left:none;width:825pt'><span style='mso-spacerun:yes'>  </span><b>I have
    ...
    ?>
      ...
      border-left:none;width:124pt'>Date :
                              <input type="text" value="<?php echo $sch_date_a; ?>" name="schedule_date[a]"  class="schedule_date form-control" id="schedule_date1" data-diff="<?php echo $diff_days; ?>" data-id="1" style="width: 107px;" data-ia-approval="<?php echo $ia_app_status; ?>"/></td>
	<?php
	...
	?>	                              
      ...
      border-left:none;width:126pt'>Date :
                              <input type="text" value="<?php echo $sch_date_b; ?>" name="schedule_date[b]"  class="schedule_date form-control" style="width: 107px;" id="schedule_date2" data-id="2" data-diff="<?php echo $diff_days; ?>" data-ia-approval="<?php echo $ia_app_status; ?>" /></td>
	...
	?>	                              
      ...
      border-left:none;width:117pt'>Date :
                              <input type="text" value="<?php echo (isset($schedule_date->c)) ? $schedule_date->c : ''; ?>" name="schedule_date[c]" data-diff="<?php echo $diff_days; ?>" class="schedule_date form-control" style="width: 107px;" id="schedule_date3" data-id="3" data-ia-approval="<?php echo $ia_app_status; ?>"/></td>
	...
	?>	
      ...
      border-left:none;width:122pt'>Date :
                              <input type="text" value="<?php echo (isset($schedule_date->d)) ? $schedule_date->d : ''; ?>" name="schedule_date[d]" data-diff="<?php echo $diff_days; ?>" class="schedule_date form-control" style="width: 107px;" id="schedule_date4" data-id="4" data-ia-approval="<?php echo $ia_app_status; ?>"/></td>
	<?php $ia_app_status=(isset($issuing_authority_approval_status->e)) ? strtolower($issuing_authority_approval_status->e) : ''; 
	 ...
	 $diff_days=$diff['days'];
      ...
      border-left:none;width:173pt'>Date :
                              <input type="text" value="<?php echo (isset($schedule_date->e)) ? $schedule_date->e : ''; ?>" name="schedule_date[e]" data-diff="<?php echo $diff_days; ?>" class="schedule_date form-control" style="width: 107px;" id="schedule_date5" data-id="5" data-ia-approval="<?php echo $ia_app_status; ?>"/></td>
	...
	?>	                              
      ...
      border-left:none;width:163pt'>Date :
                              <input type="text" value="<?php echo (isset($schedule_date->f)) ? $schedule_date->f : ''; ?>" name="schedule_date[f]" data-diff="<?php echo $diff_days; ?>" class="schedule_date form-control" style="width: 107px;" id="schedule_date6" data-id="6" data-ia-approval="<?php echo $ia_app_status; ?>"/></td>
                          </tr>
                          <tr height=21 style='height:15.75pt'>
  ...
  border-left:none;width:59pt'>
                            ...
                            <td class=xl79 width=83 style='border-top:none;border-left:none;width:65pt'><?php echo generate_time(array('class'=>'schedule_to_time','name'=>'schedule_to_time[a]','selected_value'=>(isset($schedule_to_time->a)) ? $schedule_to_time->a : '')); ?></td>
                            <td class=xl78 width=100 style='border-top:none;border-left:none;width:65pt'>
                            ...
                            <td class=xl79 width=77 style='border-top:none;border-left:none;width:61pt'><?php echo generate_time(array('class'=>'schedule_to_time','name'=>'schedule_to_time[b]','selected_value'=>(isset($schedule_to_time->b)) ? $schedule_to_time->b : '')); ?></td>
                            <td class=xl78 width=77 style='border-top:none;border-left:none;width:61pt'>
                            ...
                            <td class=xl79 width=71 style='border-top:none;border-left:none;width:56pt'><?php echo generate_time(array('class'=>'schedule_to_time','name'=>'schedule_to_time[c]','selected_value'=>(isset($schedule_to_time->c)) ? $schedule_to_time->c : '')); ?></td>
                            <td class=xl80 width=85 style='border-top:none;border-left:none;width:67pt'>
                            ...
                            <td class=xl81 width=108 style='border-top:none;border-left:none;width:55pt'><?php echo generate_time(array('class'=>'schedule_to_time','name'=>'schedule_to_time[d]','selected_value'=>(isset($schedule_to_time->d)) ? $schedule_to_time->d : '')); ?></td>
                            <td class=xl82 width=107 style='border-top:none;border-left:none;width:83pt'>
                            ...
                            <td class=xl81 width=116 style='border-top:none;border-left:none;width:90pt'><?php echo generate_time(array('class'=>'schedule_to_time','name'=>'schedule_to_time[e]','selected_value'=>(isset($schedule_to_time->e)) ? $schedule_to_time->e : '')); ?></td>
                            <td class=xl82 width=225 style='border-top:none;border-left:none;width:74pt'>
  ...
  border-left:none;width:89pt'><?php echo generate_time(array('class'=>'schedule_to_time','name'=>'schedule_to_time[f]','selected_value'=>(isset($schedule_to_time->f)) ? $schedule_to_time->f : '')); ?></td>
                          </tr>
                          <?php
     if(isset($records))
  ...
  border-left:none;width:126pt'><input type="text" value="<?php echo (isset($no_of_persons->b)) ? $no_of_persons->b : ''; ?>" name="no_of_persons[b]"  class="no_of_persons form-control" style="width: 107px;" /></td>
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:117pt'><input type="text" value="<?php echo (isset($no_of_persons->c)) ? $no_of_persons->c : ''; ?>" name="no_of_persons[c]"  class="no_of_persons form-control" style="width: 107px;" /></td>
  ...
  border-left:none;width:122pt'><input type="text" value="<?php echo (isset($no_of_persons->d)) ? $no_of_persons->d : ''; ?>" name="no_of_persons[d]"  class="no_of_persons form-control" style="width: 107px;" /></td>
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:173pt'><input type="text" value="<?php echo (isset($no_of_persons->e)) ? $no_of_persons->e : ''; ?>" name="no_of_persons[e]"  class="no_of_persons form-control" style="width: 107px;" /></td>
                            <td width="213" colspan=5 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:163pt'><input type="text" value="<?php echo (isset($no_of_persons->f)) ? $no_of_persons->f : ''; ?>" name="no_of_persons[f]"  class="no_of_persons form-control" style="width: 107px;" /></td>
                          </tr>
                          <?php
     if(isset($records))
  ...
  width:111pt'>Performing Authority</td>
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:124pt'><select id="performing_authority[a]" name="performing_authority[a]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  ?>
   ...
   ?>
                            ...
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:126pt'><select id="performing_authority[b]" name="performing_authority[b]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  ?>
   ...
   ?>
                            ...
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:117pt'><select id="performing_authority[c]" name="performing_authority[c]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  ?>
   ...
   ?>
                            ...
                            <td colspan=2 class=xl179 style='border-right:1.0pt solid black;
  border-left:none;width:122pt'><select id="performing_authority[d]" name="performing_authority[d]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  ?>
   ...
   ?>
                            ...
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:173pt'><select id="performing_authority[e]" name="performing_authority[e]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  border-left:none;width:163pt'><select id="performing_authority[f]" name="performing_authority[f]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  <select id="issuing_authority[a]" name="issuing_authority[a]"  class="issuing_authority form-control authority issuing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  <select id="issuing_authority[b]" name="issuing_authority[b]"  class="issuing_authority form-control authority issuing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  <select id="issuing_authority[c]" name="issuing_authority[c]"  class="issuing_authority form-control authority issuing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  <select id="issuing_authority[d]" name="issuing_authority[d]"  class="issuing_authority form-control authority issuing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
...
$('.required_ppe').change(function()
{
	...
	//alert($(this).attr('data-other'));
		...
		*/
		//$('input[name="hazards[n]"]:first').attr('checked',true); on 15th June 2018
...
$('input[name=is_isoloation_permit]').change(function() {
	...
	console.log('Val '+sel_val);
		...
		if(sel_val=='Existing')
		{
      //$('select.selected_eip').removeAttr('disabled');
...
$('#contractor_id').change(function() {
		...
		{
			$validate.=",'hazards[".$arr[$i]."]': {required:true},'precautions[".$arr[$i]."]': {required:true}";
		}
  ...
  $validate.=",'self_cancellation_description':{required:function(element) {
                        if($('input[name=self_cancellation]:checked').val()=='cancel')
                        return true; 
                        else return false;
                       }}";
  # $validate.=",self_cancellation_description:{required:true}";
		#$validate='';
    ...
    text_to_label();
		...
		function text_to_label()
    {
      //console.log('Working'); 
      
      var $inputs = $('form#job_form :input[type=text]:disabled');
       $inputs.each(function() {
              if($(this).val().length>0)
              {
                var originalForm = $('#'+$(this).attr('id'));
                  var div = $('<div/>',{
                       text : originalForm.val().toUpperCase(),
                       id : originalForm.attr('id'),
                       class: 'text_bold'
                    });
                   $('#'+$(this).attr('id')).replaceWith(div);
              }
          });   
      
      // for select boxes
      var $select_box_inputs = $('form#job_form select:disabled');

      $select_box_inputs.each(function(){
        if($(this).val() != '')
        {
          var originalFormSelect = $('#'+$(this).attr('id'));
            var select_div = $('<div/>',{
                 text : $("option:selected", this).text().toUpperCase(),
                 id : originalFormSelect.attr('id'),
                 class: 'text_bold'
              });
             $('#'+$(this).attr('id')).replaceWith(select_div);
        }          
      });
    }
		...
		setInterval(function() {
			...
			if(offset < 0 || offset > 6000) {
			   ...
			   //alert('System date & time is changed. Please change correct time and refresh this page');
				//$('input,select').attr('disabled',true);
