...
/*<table width="100%" align="left">
   ...
   $table.=' <tr style="border:1px solid #ccc;" >
	...
	<tr><td colspan="2"><strong>Permit NO :</strong><br />'.$records['permit_no'].'</td><td colspan="2"><strong>Start Date:</strong><br />'.$ex_date.'</td><td colspan="2">&nbsp;</td><td colspan="2"><strong>Location:</strong><br />'.strip_tags($location).'</td><td colspan="3"><strong>Nature of Job:</strong><br />'.$job_name.'</td><td colspan="5"><strong>Signature of PA:</strong><br />'.$acceptance_performing_name.'</td></tr>
	<tr><td colspan="14">&nbsp;</td></tr>
	<tr><td colspan="14" style="vertical-align:top;border:0px !important;padding-top:20px;"><img src="'.base_url().'/assets/img/check4.png" style="transform:scale(1.10);" ></td></tr></table><pagebreak />';
   ...
   $table.=' <tr style="border:1px solid #ccc;" >
	...
	$table.='<table align="left" width="100%" style="font-family: Arial, Helvetica, sans-serif; width: 100%; width: 100%; font-size: 10.5px !important; margin: 0 auto; border-collapse: collapse;">
	<tr><td colspan="2"><strong>Permit NO :</strong><br />'.$records['permit_no'].'</td><td colspan="2"><strong>Start Date:</strong><br />'.($ex_date).'</td><td colspan="2">&nbp;</td><td colspan="2"><strong>Location:</strong><br />'.strip_tags($location).'</td><td colspan="3"><strong>Nature of Job:</strong><br />'.$job_name.'</td><td colspan="5"><strong>Signature of PA:</strong><br />'.$acceptance_performing_name.'</td></tr>

	<tr><td colspan="14">&nbsp;</td></tr>
	<tr><td colspan="14" style="vertical-align:top;padding-top:40px;"><img src="'.base_url().'/assets/img/check5.png" style="transform:scale(1.15);"  ></td></tr></table>';
