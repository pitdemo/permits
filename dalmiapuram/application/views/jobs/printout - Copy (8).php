...
$acceptance_issuing_date=(isset($records['acceptance_issuing_date']) && $records['acceptance_issuing_date']!='') ? '<br />'.date('d-m-Y H:i',strtotime($records['acceptance_issuing_date'])).$hrs : ''; 	
  ...
  if($authorities!='')
  {
   ...
   // $table.='<tr><td style="border:1px solid #ccc;" colspan="2" align="center">Time</td><td style="border:1px solid #ccc;" colspan="2" align="center">Time</td><td style="border:1px solid #ccc;"colspan="2" align="center">Time</td><td style="border:1px solid #ccc;" colspan="2" align="center">Time</td><td style="border:1px solid #ccc;" colspan="2" align="center">Time</td><td style="border:1px solid #ccc;" colspan="2" align="center">Time</td> </tr>';
    ...
    $table.='<tr><td style="border:1px solid #ccc;font-size: 9px;height: 20px;"> <strong>Scaffold Tag</strong></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_a.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_b.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_c.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_d.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_e.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_f.'</b></td></tr>';
...
$row_height='height:50px;'.$fontSize;
...
{
    $tr_checklists.='<tr style="'.$row_height.'"><td height="30" style="'.$fontSize.'">&nbsp;'.$checklists[$i].'</td><td>'.$checkbox.'</td><td>'.$checkbox.'</td></tr>';
}   
...
{
    $tr_description_lists.='<tr style="'.$row_height.'"><td height="25"  style="'.$fontSize.'">&nbsp;'.$description_lists[$i].'</td><td>'.$checkbox.'</td><td>'.$checkbox.'</td></tr>';
}   

$table_no="font-size:14px;font-weight:bold;";

$table.='<table style="font-family:Arial, Helvetica, sans-serif;width:100%;font-size:9.5px !important;	margin:0 auto;border-collapse:collapse;height:120px !important;"  align="center">
		...
		<tr style="'.$row_height.'">
			<td colspan="3" style="'.$table_border.'">
					<table align="center" style="table-layout:fixed;" >
						...
						<tr style="'.$row_height.'">
							<td colspan="3" style="'.$fontSize.'">Reason for taking Permit:  '.str_repeat("_",55).'</td>
						</tr> 
						<tr style="'.$row_height.'">
						...
						<tr style="'.$row_height.'">
						<td colspan="3" style="'.$fontSize.'">Other anticipated hazard/risk, control measures detail <br /> <br />___________________________________________________________________<br /><br /><br />___________________________________________________________________</td>
						</tr>
...
<table align="right" style="'.$table_border.'table-layout:fixed;width:500px;">
		...
		<tr style="'.$row_height.'">
			<td colspan="3">'.str_repeat("_",75).'</td>
		</tr> 
		...
		<tr style="'.$row_height.'">
		<td colspan="3" style="'.$fontSize.'"><b>Field Engineer</b> '.str_repeat("&nbsp;",55).'<b style="float:right;">Co-permittee</b> <br /><br /></td>
		</tr>
...
$table.='<table style="font-family:Arial, Helvetica, sans-serif;width:100%;width:100%;font-size:8.5px !important;    margin:0 auto;border-collapse:collapse;table-layout: fixed ;"  align="center">
...
<tr>
	<td  valign="top" colspan="5" width="400px">
		<table  width="600px"   align="left" style="'.$table_border.'">
			...
			<tr style="'.$row_height.'"><td colspan="3">&nbsp;</td></tr> 

			<tr style="'.$row_height.'"><td colspan="3"  align="center"  style="'.$table_border.$row_height.'"><b>Work at height checklist - A</b></td></tr> 
			<tr style="'.$row_height.'">'.$td_checklist1.'</tr> 
			<tr style="'.$row_height.'"><td colspan="3"  align="center"  style="'.$table_border.$row_height.'"><b>Confined Space checklist - C</b></td></tr> 
			<tr style="'.$row_height.'">'.$td_checklist3.'</tr> 
			<tr style="'.$row_height.'"><td colspan="3"  align="center"  style="'.$table_border.$row_height.'"><b>Lifting work checklist - E</b></td></tr> 
	...
	<td valign="top" colspan="5" width="500px">
		...
		<tr style="'.$row_height.'"><td colspan="3"  align="center"  style="'.$table_border.$row_height.'"><b>Ergoonomical hazards control measures</b></td></tr> 
			...
			<tr style="'.$row_height.'"><td colspan="3"  align="center"  style="'.$table_border.$row_height.'"><b>Hot work checklist - B</b></td></tr> 
			<tr style="'.$row_height.'">'.$td_checklist2.'</tr> 
			<tr style="'.$row_height.'"><td colspan="3"  align="center"  style="'.$table_border.$row_height.'"><b>Excavation checklist - D</b></td></tr> 
