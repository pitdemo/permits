...
<DIV class="dclr"></DIV>
	...
	<TABLE cellpadding=0 id="isolation_table" cellspacing=0 class="t0" style="width:1024px;" align="center" >
        ...
        <?php
     	...
     	# echo 'Total : '.$total_equipment_tags; exit;
	  ...
	  ?>
       ...
       ?>
        ...
        <td> <input type="hidden" name="isolated_name_approval[<?php echo $i; ?>]" id="isolated_name_approval[<?php echo $i; ?>]" 
			...
			?>
			<td align="center">
			<input type="text" disabled="disabled" name="isolated_name_approval_datetime[<?php echo $i; ?>]" id="isolated_name_approval_datetime[<?php echo $i; ?>]" value="<?php echo $isolated_name_approval_dttime; ?>" class="form-control" style="margin:10px;width:115px;font-size:11px;"  data-attr="<?php echo $i; ?>"  />
			<br />
			<div><b style="float:left;padding-left:10px;">Name of the IA </b></div>
			<input type="text" name="isolated_ia_name[<?php echo $i; ?>]" id="isolated_ia_name[<?php echo $i; ?>]" value="<?php echo $isolated_ia_name; ?>" class="form-control" style="margin:10px;width:115px;font-size:11px;" <?php  echo $disabled2;  ?> data-attr="<?php echo $i; ?>"  />
		</td> 
		</tr>
		<?php } ?>
    </table>		
         ...
         <TABLE cellpadding=0 cellspacing=0 class="t1" id="table5" style="width:1024px;" align="center">
				...
				<?php
		         ...
		         $isolated_equipment_tag_nos=array();				 
                    ...
                    for($i=1;$i<=3;$i++)
                    {
						...
						#echo '<br /> A '.$temporary_tag_no.' && '.$disable_row;
						...
						#echo '<br /> Approval Stats '.$approval_status;
                ...
                class="form-control" name="temporary_tag_nos[<?php echo $i; ?>]" id="temporary_tag_nos[<?php echo $i; ?>]" 
                    ...
                    <select style="margin:5px;" class="form-control temporary_tags" name="temporary_tag_nos[<?php echo $i; ?>]" id="temporary_tag_nos[<?php echo $i; ?>]" data-attr="<?php echo $i; ?>" <?php echo $temp_disabled_tag_no; ?>>
                    	...
                    	<?php
                    		$isolate_type_id_sel='';
							for($tc=1;$tc<=$total_equipment_tags;$tc++)
							{
								...
								{
						?>   
                        	<option data-iso="<?php echo $isolated_name_id; ?>" <?php if( ($temporary_tag_no==$tmp_tag_nos || $prev_tmp_tag_nos==$temporary_tag_no) && $approval_status!=6) { $isolate_type_id_sel = $isolate_type_id; ?> selected="selected" <?php } ?> data-loto="<?php echo $loto; ?>" data-isolate-type-id="<?php echo $isolate_type_id; ?>" value="<?php echo $tmp_tag_nos; ?>"><?php echo $tmp_tag_nos; ?></option>
                        <?php
								}
							}
							?>
...
<br />
                ...
                <TD class="tr7 td148" colspan="2" align="center">
                <select style="width:100px;margin-top:5px;"  id="temporary_iso[<?php echo $i; ?>]" name="temporary_iso[<?php echo $i; ?>]" class="form-control temporary_iso<?php echo $i; ?>" <?php echo ($temp_disabled_iso!='') ? $temp_disabled_iso : ''; ?>>
                 <option value="" selected="selected">Select</option>
                    	<?php
...
<br />
                ...
                <TD class="tr7 td101" align="center">
               
                                <select style="width:100px;margin-top:5px;"  id="temporary_re_iso[<?php echo $i; ?>]" name="temporary_re_iso[<?php echo $i; ?>]" class="form-control temporary_re_iso<?php echo $i; ?>" <?php echo ($temp_disabled_re_iso!='') ? $temp_disabled_re_iso : ''; ?>>
                 <option value="" selected="selected">Select</option>
                    	<?php
...
?>
      ...
      if($department_isolators)
      {
          foreach($department_isolators as $department_isolator)
          {
			  ...
			  if(in_array($dept_id,array(EIP_MECHANICAL,EIP_POWER_PLANT)) && $flag==1)					
			  {
      ...
      if($department_isolators)
      {
          foreach($department_isolators as $department_isolator)
          {
			  ...
			  $flag=0;
			   ...
			   if(in_array($dept_id,array(EIP_UTILITIES,EIP_POWER_PLANT)) && $flag==1)		
			  {
...
?>
      ...
      if($department_isolators)
      {
          foreach($department_isolators as $department_isolator)
          {
			  ...
			  if(in_array($dept_id,array(EIP_PROCESS,EIP_POWER_PLANT)) && $flag==1)			
			  {
	...
	#echo '<br /> A : '.$approval_status.' - '.$user_id.' == '.$remarks_issuing_id;
		  if($eip_id!='' && !in_array($approval_status,array(11,12))) #$approval_status!=8
		  {
			  ...
			  {		
			  		...
			  		if($issuing_authority_id2_approval=='No')
			  		{
					  $label=' Approve & Submit';
...
<script type="text/javascript">
	...
	?>	
	  ...
	  console.log('Aax Call Value '+parent.$('#zone_id').val()+' = '+$('#zone_id').val());

	 

	 console.log('Aax Call END'); 
	<?php
	}
	else
	{
					      ...
					      { required:function(element)
						         { 
    								...
    								return this.value == '';
  									...
  									//if(selected_department!=total_department)
  									//console.log('Perfect');
  									//else
  									//console.log('Non Perfect');

  									//console.log('Count '+value.length+' = ".count($eip_completed_departments)."');
        ...
        submitHandler:function(){
			...
			var $inputs = $('form#job_form :input[type=text],form#job_form :input[type=hidden],select,form#job_form :input[type=radio],form#job_form :input[type=checkbox]');
			 $inputs.each(function() {
					if(this.type=='radio')
					{
						console.log('Name '+this.name+' = '+$(this).attr('class'));

						if(this.name && is_checklist==0)
						{
