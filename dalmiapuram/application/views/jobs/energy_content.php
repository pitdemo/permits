...
<DIV class="dclr"></DIV>
    ...
    <?php
      ...
      if(isset($records))
      {
		  ...
		  $self_coordinated=(isset($records['self_coordinated'])) ? $records['self_coordinated'] : '';

		  $ccr_person=(isset($records['ccr_person'])) ? $records['ccr_person'] : '';
    ...
    <TR>
        <TD class="tr8 td0"><P class="p1 ft12">&nbsp;</P></TD>
        <TD colspan=16 rowspan=2 class="tr13 td132"  style="vertical-align: top;"><P class="p22 ft5">Comment by the Issuer:</P>&nbsp;I have ensured that all isolations mentioned in clause A, B,C & D are completed. Clear to start the job.
	  	<br /><br />	
    ...
    <?php
		...
		if($performing_authority_id2==$user_id && in_array($performing_authority_id2_approval,array('','No'))){
		$dis='';
		}
    ...
    <TR>
        <TD class="tr2 td0"><P class="p1 ft1">&nbsp;</P></TD>
        <TD colspan=16 class="tr2 td132"><P class="p14 ft8">I understand clause A,B,C&D, I shall maintain conditions as required.</P><br /><br /> Self <input type="text" class="form-control" name="self_coordinated" id="self_coordinated" style="width:20%;display:inline;" value="<?php echo $self_coordinated; ?>"  <?php echo $dis; ?>/> Coordinated with CCR Operator <input type="text" class="form-control" name="ccr_person" id="ccr_person" style="width:20%;display:inline;" value="<?php echo $ccr_person; ?>" <?php echo $dis; ?>/> to give the equipment in local mode and forcibly started the equipment and found that there is no supply in the equipment</TD>
		 ...
		 ?>
			...
			rules: {
				...
				<?php echo $validate;
					...
					if($approval_status==5)
					{
						echo ',self_coordinated:{required:true},ccr_person:{required:true}';
					}
