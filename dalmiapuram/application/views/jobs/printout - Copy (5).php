...
/*<table width="100%" align="left">
   ...
   $table.=' <tr style="border:1px solid #ccc;" >
	...
	$table.='</table>';
	$table.='<table align="left" width="100%" style="font-family: Arial, Helvetica, sans-serif; width: 100%; width: 100%; font-size: 10.5px !important; margin: 0 auto; border-collapse: collapse;">
	<tr><td colspan="12">&nbsp;</td></tr>
	<tr><td colspan="2"><strong>Start Date:</strong><br />'.$location_time_start.'</td><td colspan="2"><strong>End Date:</strong><br />'.$location_time_to.'</td><td colspan="2"><strong>Location:</strong><br />'.strip_tags($location).'</td><td colspan="3"><strong>Nature of Job:</strong><br />'.$job_name.'</td><td colspan="5"><strong>Signature of Performing Authority:</strong><br />'.$acceptance_performing_name.'</td></tr>
	<tr><td colspan="12">&nbsp;</td></tr>
	<tr><td colspan="12" style="vertical-align:top;"><img src="'.base_url().'/assets/img/checklist4.jpg" style="height:625px;width:950px;" ></td></tr></table>';
   ...
   $table.=' <tr style="border:1px solid #ccc;" >
	...
	$table.='<table align="left" width="100%" style="font-family: Arial, Helvetica, sans-serif; width: 100%; width: 100%; font-size: 10.5px !important; margin: 0 auto; border-collapse: collapse;padding-top:50px;">
	<tr><td colspan="12">&nbsp;</td></tr>
	<tr><td colspan="2"><strong>Start Date:</strong><br />'.$location_time_start.'</td><td colspan="2"><strong>End Date:</strong><br />'.$location_time_to.'</td><td colspan="2"><strong>Location:</strong><br />'.strip_tags($location).'</td><td colspan="3"><strong>Nature of Job:</strong><br />'.$job_name.'</td><td colspan="5"><strong>Signature of Performing Authority:</strong><br />'.$acceptance_performing_name.'</td></tr>
	<tr><td colspan="12">&nbsp;</td></tr>
	<tr><td colspan="12" style="vertical-align:top;"><img src="'.base_url().'/assets/img/checklist5.jpg" style="height:595px;width:950px;" ></td></tr></table>';
