...
<DIV class="dclr"></DIV>
    ...
    <table align="center" width="100%" border="1" class="equip_table">
		...
		#print_r($isolated_equipment_descriptions);
...
<select <?php echo $ia_id3; ?> style="margin:5px;width: 165px;" id="issuing_authority_id3" name="issuing_authority_id3" class="form-control issuing authority" >
      ...
      ?>
       ...
       ?>
                                    ...
                                    <br />
                                    <input <?php echo $ia_id3; ?> type="text" class="form-control" name="issuing_authority_3_name" id="issuing_authority_3_name" style="width:200px;margin:5px;"  value="<?php echo $issuing_authority_3_name; ?>"/>
		...
		for($i=2;$i<=$total_equipment_tags;$i++)
		{
		 ...
		 ?>
			...
			rules: {
				...
				'issuing_authority_3_name': { required : true }
				<?php echo $validate;
					if($approval_status==4)
					{
