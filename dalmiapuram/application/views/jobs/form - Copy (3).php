...
<div class="wrapper row-offcanvas row-offcanvas-left">
 ...
 <a class="thickbox" href="<?php echo base_url(); ?>jobs/ajax_show_energy_info/?TB_iframe=true&keepThis=true&width=1050" id="energy_form" title=" Energy Isolation Permit Form" style="visibility:hidden;">Thickbox</a>
  ...
  ?>
                              <br />
                              <input type="radio" disabled="disabled" class="radio_button on_off" data-relate='scaffolding' name="is_scaffolding_certification"  <?php echo $yes_active; ?> value="Yes"/>
                              Yes&nbsp;
                              <input type="radio"  disabled="disabled" <?php echo $no_active; ?> class="radio_button on_off" data-relate='scaffolding' name="is_scaffolding_certification" value="No"/>
                              No&nbsp;
                               </td>
