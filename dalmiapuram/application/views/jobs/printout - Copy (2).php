...
/*<table width="100%" align="left">
  ...
  $work_types=array();
    ...
    $table.='<tr><td style="border:1px solid #ccc; width: 20% !important;vertical-align: top;" colspan="3"> <strong>HEIGHT WORK </strong>'.$height_work_checked.' <br>Work at a Height of 1.5 Mts & above</td><td style="border:1px solid #ccc;"colspan="3" style="width: 20% !important; vertical-align: top;"><strong>HOT WORK</strong>&nbsp;&nbsp;'.$hot_work_checked.'<br>Work related to <br>Welding / Cutting / Grinding / Open flame</td><td style="border:1px solid #ccc;width: 20% !important;vertical-align: top;"colspan="3" ><strong>GENERAL WORK</strong>&nbsp;&nbsp;'.$general_work_checked.'<br>Works other than Height, Hot, Confined<br>Space, Electrical & Exavation</td><td style="border:1px solid #ccc;width: 20% !important;vertical-align: top;"colspan="4" ><b>Line</b><br /><br />
    ...
    $table.='<tr ><td style="border:1px solid #ccc;"rowspan="4" colspan="2" valign="top"><b>Zone</b><br />'.$zone_name.'<br /><br /><b>Location</b><br />'.$location.'</td><td style="border: 1px solid #cccccc;" colspan="3" align="center">Date & Time</td><td style="border:1px solid #ccc;"colspan="3"><strong>Hazards / concersn identified:</strong></td><td><strong>YES / NO</strong></td><td style="border:1px solid #ccc !important;"colspan="3"><strong>Precautions to be Taken :</strong></td><td><strong>YES / NA</strong></td> </tr>';
 ...
 $precautions_options=array();
  ...
  $location_date=(isset($records['location_date'])) ? $records['location_date'] : '';
	...
	a) Standard & certified Scaffold provide '.$pre_text.'</td><td style="border:1px solid #cccccc;" align="center">'.$pre.'</td></tr>';
  ...
  $pre_text= (isset($precautions_text->f)) ? '<br /><b>'.strtoupper($precautions_text->f).'</b>' : '';
    ...
    $table.='<tr><td style="border:1px solid #ccc;"colspan="5">Name of the contractor : <b>'.$contractor_name.'</b><br /><br> No.of persons involved : <b>'.$contractors_involved.'</b></td><td style="border:1px solid #ccc;"colspan="3">f) Fall of person from -height</td><td style="border:1px solid #cccccc;" align="center">'.$haz.'</td><td style="border:1px solid #ccc;"colspan="3">f)  '.$pre_checked_1.' User of Full Body Harness <br /> '.$pre_checked_2.' Anchor points  '.$pre_checked_3.' fall arrestors <br />'.$pre_checked_4.' Safety Nets '.$pre_checked_5.' life lines  '.$pre_checked_6.' vertigo Test Certificate ensured as required.'.$pre_text.'</td><td style="border:1px solid #cccccc;" align="center">'.$pre.'</td> </tr>';
  ...
  $pre_text= (isset($precautions_text->h)) ? '<br /><b>'.strtoupper($precautions_text->h).'</b>' : '';
	  ...
	  if($eips->num_rows()>0)
	  {
		  ...
		  foreach($fet_eips as $fet_eip)
		  {
			  ...
			  if(array_search($eip_id,$jobs_isoloations_ids)!==FALSE)
				$eip_yes_selection.=strtoupper($eip_section.'(#'.$eip_id.'),');
		  }
...
$scaffolding_certification_no=(isset($records['scaffolding_certification_no']) && $records['scaffolding_certification_no']!='') ? strtoupper($records['scaffolding_certification_no']) : 'NA';
  ...
  $pre_text= (isset($precautions_text->k)) ? '<br /><b>'.strtoupper($precautions_text->k).'</b>' : '';
	...
	</td><td style="border:1px solid #ccc;"colspan="3">k) '.$checked_1.' Moving Machinery '.$checked_2.' Electric shock '.$checked_3.' Other Entergy </td><td style="border:1px solid #cccccc;" align="center">'.$haz.'</td><td style="border:1px solid #ccc;"colspan="3">k) Hazardous Energy Isolation ensured '.$pre_text.'
...
$precautions_other = (isset($records['precautions_other'])) ? '<b>'.strtoupper($records['precautions_other']).'</b>' : '';
 ...
 $st=(isset($records['status'])) ? $records['status'] : '';
    ...
    $table.='<tr rowspan="6"><td style="border:1px solid #ccc;"colspan="3" align="center"><strong>Required PPE</strong></td><td style="border:1px solid #ccc;" colspan="5" ><span style="text-align:center;"><strong>Authorisation & Acceptance</span><br>Performing Authority:<br>
            </strong></td><td style="border:1px solid #ccc;"colspan="5"><strong>Work '.$work_msg.' <br />Performing Authority:</strong></td></tr>';
    $table.='<tr><td style="border:1px solid #ccc; vertical-align: middle;" >'.$safety_checked.'<strong> Safety shoes</strong></td><td style="border:1px solid #ccc;vertical-align: middle;"colspan="2">'.$eye_checked.' <strong> Eye Protetion</strong> </td><td style="border:1px solid #ccc;"colspan="5">I have had the contents fo this permit explained to me and i shall work in aordance with the ontrol measures identified.</td><td style="border:1px solid #ccc;"colspan="5">Work completed, all persons are withdrawn and material removed from the area.</td></tr>';
 ...
 $cancellation_performing_name='';
  ...
  if($authorities!='')
  {
    ...
    $table.='<tr><td style="border: 1px solid #cccccc;">'.$safety_helmet_checked.' <strong> Safety Helmet</strong></td><td style="border:1px solid #ccc;"colspan="2">'.$ear_checked.'<strong> Ear protection</strong></td><td style="border:1px solid #ccc;"colspan="2">Name : <strong>'.$acceptance_performing_name.'</strong> </td><td style="border:1px solid #ccc;"colspan="3">
	Digitally Signed/Date&Time: <b>'.$acceptance_performing_date.'</b></td> <td style="border:1px solid #ccc;"colspan="2">Name : <strong>'.$cancellation_performing_name.'</strong></td><td style="border:1px solid #ccc;"colspan="3">Digitally Signed/Date&Time: <b>'.$cancellation_performing_date.'</b></td> </tr>';

	
    $table.='<tr><td style="border:1px solid #ccc;"style="font-size: 8px;">'.$fullbody_checked.'<strong> Full body Harness</strong> </td><td style="border:1px solid #ccc;"colspan="2">'.$welding_checked.'<strong> Welding Sheild</strong></td><td style="border:1px solid #ccc;"colspan="5"><strong>Issuing Authority: </strong></td><td style="border:1px solid #ccc;"colspan="5"> <strong>Issuing Authority:</strong></td> </tr>';
	
    $table.='<tr><td style="border: 1px solid #cccccc;">'.$safety_net_checked.'<strong> Safety Net</strong> </td><td style="border:1px solid #ccc;"colspan="2">'.$coverall_checked.'<strong> Coverall Suit</strong></td><td style="border:1px solid #ccc;"colspan="5">I have ensured that each of the identified control measures is suitable and sufficient. The content of this permit has been explained to the holder and work may proceed. </td><td style="border:1px solid #ccc;"colspan="5">I have inspected the work area and declare the work for whih the permit was issued has been properly performed</td></tr>';
...
$acceptance_issuing_date=(isset($records['acceptance_issuing_date']) && $records['acceptance_issuing_date']!='') ? '<br />'.date('d-m-Y H:i',strtotime($records['acceptance_issuing_date'])).$hrs : ''; 	
  ...
  if($authorities!='')
  {
    ...
    $table.='<tr><td style="border: 1px solid #cccccc;">'.$other_checked.'<strong> Others </strong></td><td style="border:1px solid #ccc;"colspan="2"><b>'.strtoupper($required_ppe_other).'</b></td><td style="border:1px solid #ccc;"colspan="5"><td style="border:1px solid #ccc;"colspan="5"></td> </tr>';
    ...
    $table.='<tr><td style="border: 1px solid #cccccc;"><strong>Revalidation:</strong></td><td style="border:1px solid #ccc;"colspan="12">I have visited the work area and understand and well omply with the requirements of this permit</td> </tr>';
    ...
    $table.='<tr><td style="border:1px solid #ccc;"rowspan="4"><strong>SCHEDULE</strong></td><td style="border:1px solid #ccc;"colspan="2"><strong>Date: '.$s_date_a.'</strong></td><td style="border:1px solid #ccc;"colspan="2"><strong>Date: '.$s_date_b.'</strong></td><td style="border:1px solid #ccc;"colspan="2"><strong>Date: '.$s_date_c.'</strong></td><td style="border:1px solid #ccc;"colspan="2"><strong>Date: '.$s_date_d.'</strong></td><td style="border:1px solid #ccc;"colspan="2"><strong>Date: '.$s_date_e.'</strong></td><td style="border:1px solid #ccc;"colspan="2"><strong>Date:'.$s_date_f.'</strong></td></tr>';
    ...
    $table.='<tr><td style="border:1px solid #ccc;font-size: 9px;height: 20px;"> <strong>Issuing Authority</strong></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$issuing_authority_name_a.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$issuing_authority_name_b.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$issuing_authority_name_c.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$issuing_authority_name_d.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$issuing_authority_name_e.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$issuing_authority_name_f.'</b></td></tr>';
    ...
    $table.='<tr><td style="border:1px solid #ccc;font-size: 9px;height: 20px;"> <strong>Scaffhold Tag</strong></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_a.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_b.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_c.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_d.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_e.'</b></td><td style="border:1px solid #ccc;"colspan="2" align="center"><b>'.$ref_f.'</b></td></tr>';
