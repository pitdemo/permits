...
<!-- #include virtual="/convert-pdf-to-html/includes/pdf-to-word-body-tag-02242014.htm" -->
    ...
    <tr>
        ...
        <input type="hidden" id="approval_status" name="approval_status" value="<?php echo $approval_status; ?>" />
			<DIV id="page_1">
<DIV class="dclr"></DIV>
    <P class="p0 ft0">Dalmia Cement (B) Ltd - Ariyalur</P>
    ...
    <TR>
        ...
        <TD colspan=2 class="tr0 td4"><P class="p1 ft3">SL.NO. <?php echo $sl_no; ?></P></TD>
    </TR>
    <TR>
    ...
    <TR>
        ...
        <TD colspan=4 class="border_right" ><P class="p5 ft8">Ref.Work Permit Nos.</P></TD>
    </TR>
    <TR>
        ...
        <TD colspan=4 class="border_right" ><input style="width:150px;" readonly  type="text" class="form-control" name="work_permit_nos" id="work_permit_nos" value="<?php echo (isset($records['work_permit_nos'])) ? $records['work_permit_nos'] : ''; ?>"  /></TD>
    </TR>
    ...
    <TR>
        ...
        <TD colspan=9 class="tr7 td6"><b>Description of Work:</b>
        	...
        	<ol>
        		<?php
        			...
        			{
	        	?>		
        		<li style="margin-left:10px;">#<?php echo $job_desc['permit_no'].' - '.$job_desc['job_name']; ?></li>
        		<?php
	        		}
	        	?>	
        	</ol>
    ...
    <TR>
        <TD colspan=2 class="tr8 td25"><P style="text-align:center;">Sl.No.</P></TD>
		...
		# $equip_row=(count($equipment_descriptions)>0 && $approval_status>=2) ? count($equipment_descriptions) : 10;
		 
		 #echo '<pre>'; print_r($equipment_descriptions); echo '<br /> Count : '.count($equipment_descriptions); exit;
        ...
        ?>	
        <TR>
            <TD colspan=2 class="tr10 td54"><P style="text-align:center;"><?php echo $i; ?></P></TD>
            <TD class="tr10 td24 border_right" colspan="3"><input type="text" class="form-control" name="equipment_descriptions[<?php echo $i; ?>]" id="equipment_descriptions[<?php echo $i; ?>]" 
            value="<?php echo (isset($equipment_descriptions->$i)) ? $equipment_descriptions->$i : ''; ?>"  />
            </TD>
            <TD class="tr10 td8 border_right" colspan="4"><input   type="text" class="form-control" name="equipment_tag_nos[<?php echo $i; ?>]" id="equipment_tag_no[<?php echo $i; ?>]" 
            value="<?php echo (isset($equipment_tag_nos->$i)) ? $equipment_tag_nos->$i : ''; ?>"  /></TD>
            <TD  colspan="3" class="tr10 td56 border_right">
            <?php /* <input  type="text" class="form-control" name="isolate_types[<?php echo $i; ?>]" id="isolate_type[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolate_types->$i)) ? $isolate_types->$i : ''; ?>"  />--> */ ?>
            <?php $isolate_type=(isset($isolate_types->$i)) ? $isolate_types->$i : ''; ?>
			<select name="isolate_types[<?php echo $i; ?>]" id="isolate_type[<?php echo $i; ?>]" class="form-control">
    ...
    <P class="p16 ft11">(c) To be filled by the authorized person (Performing Authority/Isolator) who is carrying out the isolations.</P>
   		 <TABLE cellpadding=0 cellspacing=0 class="t1" id="table2" style="width:1024px;" align="center">
    <TR>
        <TD class="tr9 td48"><P class="p1 ft14">&nbsp;</P></TD>
        <TD class="tr9 td64"><P class="p14 ft20">Sl.</P></TD>
        <TD class="tr9 td65"><P class="p1 ft14">&nbsp;</P></TD>
        <TD class="tr9 td66" ><P class="p12 ft20" style="text-align:center;">Equipment</P></TD>
        <TD colspan=2 class="tr9 td67"><P class="p17 ft20" style="text-align:center;">Isolation</P></TD>
        <TD class="tr9 td68"><P class="p1 ft14">&nbsp;</P></TD>
        <TD colspan=3 class="tr9 td69"><P class="p1 ft20">Description</P></TD>
        <TD class="tr9 td70"><P class="p1 ft14">&nbsp;</P></TD>
        <TD class="tr9 td71"><P class="p1 ft14">&nbsp;</P></TD>
        <TD colspan=5 rowspan=2 class="tr18 td72"><P class="p14 ft5">LOTO Lock & Tag No.</P></TD>
        <TD class="tr9 td73"><P class="p1 ft14">&nbsp;</P></TD>
        <TD colspan=5 class="tr9 td74 border_right"><P class="p18 ft20">Name of the</P></TD>
        <TD rowspan=2 class="tr18 td76 border_right" colspan="2"><P class="p1 ft5" style="text-align:center;">Signature/Date&Time</P></TD>
    </TR>
    <TR>
        <TD class="tr19 td0"><P class="p1 ft21">&nbsp;</P></TD>
        <TD rowspan=2 class="tr10 td77"><P class="p4 ft5">No.</P></TD>
        <TD class="tr19 td78"><P class="p1 ft21">&nbsp;</P></TD>
        <TD rowspan=2 class="tr10 td79" ><P class="p19 ft5" style="text-align:center;">Tag No.</P></TD>
        <TD colspan=2 rowspan=2 class="tr10 td80"><P class="p17 ft5" style="text-align:center;">Type</P></TD>
        <TD class="tr19 td81"><P class="p1 ft21">&nbsp;</P></TD>
        <TD colspan=2 rowspan=2 class="tr10 td82"><P class="p20 ft10">of Isolation</P></TD>
        <TD class="tr19 td83"><P class="p1 ft21">&nbsp;</P></TD>
        <TD class="tr19 td84"><P class="p1 ft21">&nbsp;</P></TD>
        <TD class="tr19 td85"><P class="p1 ft21">&nbsp;</P></TD>
        <TD class="tr19 td86"><P class="p1 ft21">&nbsp;</P></TD>
        <TD colspan=5 rowspan=2 class="tr10 td87 border_right"><P class="p6 ft5">Auth.Isolator</P></TD>
    </TR>
    <TR>
        <TD class="tr15 td5"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td89"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td90"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td91"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td92"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td93"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td94"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td95"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td96"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td97"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td98"><P class="p1 ft18">&nbsp;</P></TD>
        <TD class="tr15 td99"><P class="p1 ft18">&nbsp;</P></TD>
		...
		#echo '<pre>'; print_r($isolations->result_array()); exit;
         if(isset($records))
		 ...
		 #echo '<pre>'; print_r($isolated_name_approval_datetime); exit;
       
		#$equi_desc_row=(count($isolated_equipment_descriptions)) ? count($isolated_equipment_descriptions)+1 : 10;
		
		#$equip_row=(count($isolated_equipment_descriptions)>0 && $approval_status>=2) ? count($isolated_equipment_descriptions) : 10;
        ...
        <TR>
        <TD class="tr7 td5"><P class="p1 ft1">&nbsp;</P></TD>
        <TD class="tr7 td77" style="text-align:center;vertical-align:middle;"><?php echo $i; ?></TD>
        <TD class="tr7 td89 border_right" colspan="2"><P class="p1 ft1">
        
        <?php 
			$isolated_equipment_tag_no=(isset($isolated_equipment_tag_nos->$i)) ? $isolated_equipment_tag_nos->$i : '';
			
			#echo '<br /> Yes : '.$isolated_equipment_tag_nos;
			...
			if(empty($isolated_equipment_tag_no))
			$disabled='disabled="disabled"';
		?>
        ...
        <TD class="tr7 td102 border_right" colspan="2">
		...
		?>	
			<select style="margin:5px;width:120px;" name="isolated_isolate_types[<?php echo $i; ?>]" id="isolated_isolate_types[<?php echo $i; ?>]" class="form-control isolated_isolate_types" <?php  echo $disabled; ?> data-attr="<?php echo $i; ?>" >
                                      <option value="">- Select -</option>
                                      <?php
	  if(count($isolations)>0)
	  {
	  ...
	  ?>
       ...
       ?>
        ...
        <TD class="tr7 td90 border_right" colspan="4"><P class="p1 ft1">
        <?php #echo 'FF '.$isolated_isolate_type; ?>
       <select style="margin:5px;width:82px;"  id="isolated_equipment_descriptions[<?php echo $i; ?>]"  name="isolated_equipment_descriptions[<?php echo $i; ?>]" class="form-control isolated_equipment_descriptions" <?php  echo $disabled; ?>>
                                      <option value="">- Select-</option>
                                      <?php
	  if(count($isolations)>0)
	  {
	  ...
	  ?>
       ...
       ?>
        ...
        <TD class="tr7 td92 border_right" colspan="2"><P class="p1 ft1"><input type="text" class="form-control" name="isolated_tagno1[<?php echo $i; ?>]" id="isolated_tagno1[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolated_tagno1->$i)) ? $isolated_tagno1->$i : ''; ?>" <?php  echo $disabled; ?>  style="margin:2px;width:72px;"  /></P></TD>
        <TD class="tr7 td106 border_right" colspan="2"><P class="p1 ft1"><input type="text" class="form-control" name="isolated_tagno2[<?php echo $i; ?>]" id="isolated_tagno2[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolated_tagno2->$i)) ? $isolated_tagno2->$i : ''; ?>" <?php  echo $disabled; ?>  style="margin:2px;width:72px;"  /></P></TD>
        <TD class="tr7 td107  border_right" colspan="2"><P class="p1 ft1"><input type="text" class="form-control" name="isolated_tagno3[<?php echo $i; ?>]" id="isolated_tagno3[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolated_tagno3->$i)) ? $isolated_tagno3->$i : ''; ?>"  style="margin:2px;width:72px;" <?php  echo $disabled2;  ?>  /></P></TD>
        <TD class="tr7 td95  border_right" colspan="2"><P class="p1 ft1"><input type="text" class="form-control" name="isolated_tagno4[<?php echo $i; ?>]" id="isolated_tagno4[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolated_tagno4->$i)) ? $isolated_tagno4->$i : ''; ?>"  style="margin:2px;width:72px;" <?php  echo $disabled2;  ?> /></P></TD>
        <TD class="tr7 td108  border_right" colspan="5"><P class="p1 ft1">
      <input type="hidden" name="isolated_name_approval[<?php echo $i; ?>]" id="isolated_name_approval[<?php echo $i; ?>]" 
            value="<?php echo $isolated_name_approval; ?>"  /> 
            
            <?php #echo 'FF '.$isolated_isolate_type; ?>
			<select style="margin:5px;width:140px;" name="isolated_name[<?php echo $i; ?>]" id="isolated_name[<?php echo $i; ?>]" class="form-control isolated_name data-iso-name<?php echo $isolated_name_id; ?>"  data-attr="<?php echo $i; ?>" <?php  echo $disabled; ?>>
                                      <option value="">- Select -</option>
                                    <?php
			...
			?>
        <TD class="tr7 td110" colspan="2"><input type="text" disabled="disabled" name="isolated_name_approval_datetime[<?php echo $i; ?>]" id="isolated_name_approval_datetime[<?php echo $i; ?>]" value="<?php echo $isolated_name_approval_dttime; ?>" class="form-control" style="margin:10px;width:115px;font-size:11px;"  data-attr="<?php echo $i; ?>"  /> </TD>
        <!-- <TD class="tr7 td111"><P class="p1 ft1">&nbsp;</P></TD> -->
    </TR>
        <?php
        }
        ?>
    ...
    <TR>
        ...
        <select style="margin:5px;width: 165px;" id="issuing_authority_id2" name="issuing_authority_id2" class="form-control issuing authority" disabled="disabled">
                                      <option value="">- - Select - -</option>
                                      <?php
    ...
    <TR rowspan="2">
        ...
        <?php  $issuing_authority_id2_date=(isset($records['issuing_authority_id2_date'])) ? $records['issuing_authority_id2_date'] : '';
			
				if($issuing_authority_id2==$user_id && $issuing_authority_id2_approval=='No' && $issuing_authority_id2_date=='')
				$issuing_authority_id2_date=date('d-m-Y');
    ...
    <TR>
    	...
    	?>
         ...
         <TABLE cellpadding=0 cellspacing=0 class="t1" id="table5" style="width:1024px;" align="center">
                <TR>
                    <TD class="tr10 td5"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD colspan=16 class="tr10 td142"><P class="p5 ft5">(F)Temporary Energization & <NOBR>Re-Isolation.Only</NOBR> Same Lock & Tag only to be reused.</P></TD>
                    <TD class="tr10 td90"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td109"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td110"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td111"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td96"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td100"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td101"><P class="p1 ft1">&nbsp;</P></TD>
                </TR>
                <TR>
                    <TD class="tr10 td0"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td143"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td144"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td15"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD class="tr10 td145"><P class="p1 ft1">&nbsp;</P></TD>
                    <TD colspan=3 rowspan=2 class="tr22 td146"><P class="p23 ft26">LOTO Lock &</P></TD>
                    <TD class="tr8 td105"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD class="tr8 td114"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD class="tr8 td92"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD colspan=3 class="tr8 td147"><P class="p1 ft27">Energization</P></TD>
                    <TD class="tr8 td96"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD class="tr8 td148"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD class="tr8 td98"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD class="tr8 td90"><P class="p1 ft12">&nbsp;</P></TD>
                    <TD colspan=5 class="tr8 td138"><P class="p24 ft27"><NOBR>Re-Isolation</NOBR></P></TD>
                    <TD class="tr8 td101"><P class="p1 ft12">&nbsp;</P></TD>
                </TR>
                <TR>
                    <TD class="tr4 td0"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=2 rowspan=2 class="tr12 td149"><P class="p15 ft28">Sl.</P></TD>
                    <TD class="tr4 td15"><P class="p6 ft29">Equipment</P></TD>
                    <TD class="tr4 td145"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td141"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=2 rowspan=2 class="tr12 td150"><P class="p9 ft30">Sign of</P></TD>
                    <TD colspan=3 rowspan=2 class="tr12 td151"><P class="p11 ft30">Sign of Issuing</P></TD>
                    <TD colspan=2 rowspan=2 class="tr12 td152"><P class="p14 ft30">Sign of Isolator</P></TD>
                    <TD class="tr4 td131"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td81"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD rowspan=2 class="tr12 td153"><P class="p14 ft30">Sign of</P></TD>
                    <TD class="tr4 td120"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=3 rowspan=2 class="tr12 td154"><P class="p1 ft30">Sign of Issuing</P></TD>
                    <TD rowspan=2 class="tr12 td123"><P class="p14 ft30">Sign of Isolator</P></TD>
                </TR>
                <TR>
                    <TD class="tr6 td0"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td15"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td145"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td155"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td81"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td39"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td141"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td131"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td81"><P class="p1 ft9">&nbsp;</P></TD>
                    <TD class="tr6 td120"><P class="p1 ft9">&nbsp;</P></TD>
                </TR>
                <TR>
                    <TD class="tr9 td0"><P class="p1 ft14">&nbsp;</P></TD>
                    <TD colspan=2 class="tr9 td149"><P class="p3 ft31">No.</P></TD>
                    <TD class="tr9 td15"><P class="p25 ft26">Tag No.</P></TD>
                    <TD class="tr9 td145"><P class="p1 ft14">&nbsp;</P></TD>
                    <TD colspan=2 class="tr9 td124"><P class="p26 ft26">Tag No.</P></TD>
                    <TD class="tr9 td39"><P class="p1 ft14">&nbsp;</P></TD>
                    <TD class="tr9 td141"><P class="p1 ft14">&nbsp;</P></TD>
                    <TD colspan=2 class="tr9 td150"><P class="p27 ft26">Performing</P></TD>
                    <TD colspan=3 class="tr9 td151"><P class="p11 ft26">Authority with</P></TD>
                    <TD colspan=2 class="tr9 td152"><P class="p28 ft26">with</P></TD>
                    <TD class="tr9 td131"><P class="p1 ft14">&nbsp;</P></TD>
                    <TD colspan=2 class="tr9 td156"><P class="p11 ft26">Performing</P></TD>
                    <TD class="tr9 td120"><P class="p1 ft14">&nbsp;</P></TD>
                    <TD colspan=3 class="tr9 td154"><P class="p29 ft26">Authority with</P></TD>
                    <TD class="tr9 td123"><P class="p29 ft26">with</P></TD>
                </TR>
                <TR>
                    <TD class="tr4 td5"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td136"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td157"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td8"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td158"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td137"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td90"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td54"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD class="tr4 td105"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=2 class="tr4 td159"><P class="p30 ft29">Authority</P></TD>
                    <TD class="tr4 td93"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=2 class="tr4 td160"><P class="p1 ft29">date and time</P></TD>
                    <TD colspan=2 class="tr4 td161"><P class="p28 ft29">date and time</P></TD>
                    <TD class="tr4 td98"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=2 class="tr4 td162"><P class="p9 ft29">Authority</P></TD>
                    <TD class="tr4 td110"><P class="p1 ft7">&nbsp;</P></TD>
                    <TD colspan=3 class="tr4 td79"><P class="p29 ft29">date and time</P></TD>
                    <TD class="tr4 td101"><P class="p29 ft29">date and time</P></TD>
                </TR>
                 ...
                 $temporary_re_iso_signdates=array();
                    ...
                    for($i=1;$i<=3;$i++)
                    {
						...
						if($temporary_tag_no!='' && $disable_row==0)
						{
								...
								else if($user_id==$temporary_iso && $temporary_iso_signdate=='')
								{
								...
								else if($user_id==$temporary_re_iso && $temporary_re_iso_signdate=='')
								{
						...
						if($temporary_iso_signdate!='' && $temporary_ia_signdate!='' && $is_re==0 && $disable_row==0)
						{
                ...
                ?>		
                    ...
                    <TR>
                <TD class="tr13 td0"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td136" style="vertical-align:middle;"><P class="p12 ft32" style="text-align:center;vertical-align:middle;"><?php echo $i; ?></P></TD>
                <TD class="tr7 td157"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td8" style="vertical-align:middle;"><P class="p1 ft1">&nbsp;</P>
                
                <!-- <input style="margin:5px;"   type="text" 
                class="form-control" name="temporary_tag_nos[<?php echo $i; ?>]" id="temporary_tag_nos[<?php echo $i; ?>]" 
                    value="<?php echo (isset($temporary_tag_nos->$i)) ? $temporary_tag_nos->$i : ''; ?>" /> -->
                    <span id="allow_equip<?php echo $temporary_tag_no; ?>" style="visibility:hidden;"><?php echo $allow_equip; ?></span>
                    
                    <select style="margin:5px;" class="form-control temporary_tags" name="temporary_tag_nos[<?php echo $i; ?>]" id="temporary_tag_nos[<?php echo $i; ?>]" data-attr="<?php echo $i; ?>" <?php echo $temp_disabled_tag_no; ?>>
                    	<option value="" selected="selected">Select</option>
                    	<?php
							for($tc=1;$tc<=10;$tc++)
							{
								...
								{
						?>   
                        	<option data-iso="<?php echo $isolated_name_id; ?>" <?php if($temporary_tag_no==$tmp_tag_nos) { ?> selected="selected" <?php } ?> data-loto="<?php echo $loto; ?>" value="<?php echo $tmp_tag_nos; ?>"><?php echo $tmp_tag_nos; ?></option>
                        <?php
								}
							}
							?>
                ...
                <TD class="tr7 td158"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td137" style="vertical-align:middle;">
                <span id="temporary_lock_nos<?php echo $i; ?>" ><?php echo (isset($temporary_lock_nos->$i)) ? $temporary_lock_nos->$i : ''; ?></span>
                ...
                <TD class="tr7 td90"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td54"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td105"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td54" colspan="2"><P class="p1 ft1">&nbsp;</P>
        <select <?php echo ($temp_disabled_pa!='') ? $temp_disabled_pa : ''; ?> style="width:100px;margin-top:5px;" id="temporary_pa[<?php echo $i; ?>]" name="temporary_pa[<?php echo $i; ?>]"  class="form-control temporary_pa<?php echo $i; ?> authority_sign" data-date-field="temporary_pa_signdates<?php echo $i; ?>" data-selection="pa" data-attr="<?php echo $i; ?>" >
                                      <option value="" selected="selected">- - Select - -</option>
                                      <?php
...
<br />
                ...
                <input type="text" readonly="readonly"  class="form-control temporary_pa_signdates<?php echo $i; ?>" name="temporary_pa_signdates[<?php echo $i; ?>]" id="temporary_pa_signdates[<?php echo $i; ?>]" 
                style="margin-bottom:5px;width:100px;font-size:9px;"     value="<?php echo $temporary_pa_signdate; ?>"  />                                    
                
                </TD>
                <!-- <TD class="tr7 td163"><P class="p1 ft1">&nbsp;</P>2332</TD> -->
                <TD class="tr7 td93"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td94">
                   <select style="width:100px;margin-top:5px;" <?php echo ($temp_disabled_ia!='') ? $temp_disabled_ia : ''; ?>  id="temporary_ia[<?php echo $i; ?>]" name="temporary_ia[<?php echo $i; ?>]" class="form-control temporary_ia<?php echo $i; ?> authority_sign" data-selection="ia" data-attr="<?php echo $i; ?>">
                                                      <option value="">- - Select - -</option>
                                                      <?php
                                         if($issuing_authorities!='')
                                          {
...
<br />
                ...
                <input type="text" readonly="readonly"  class="form-control" name="temporary_ia_signdates[<?php echo $i; ?>]" id="temporary_ia_signdates[<?php echo $i; ?>]" style="margin-bottom:5px;width:100px;font-size:9px;"     value="<?php echo $temporary_ia_signdate; ?>"  />                                    
                                                    
                </TD>
                <TD class="tr7 td164" ><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td148" colspan="2">
                <select style="width:100px;margin-top:5px;"  id="temporary_iso[<?php echo $i; ?>]" name="temporary_iso[<?php echo $i; ?>]" class="form-control temporary_iso<?php echo $i; ?>" <?php echo ($temp_disabled_iso!='') ? $temp_disabled_iso : 'disabled="disabled"'; ?>>
                 <option value="" selected="selected">- - Select - -</option>
                    	<?php
						...
						?><option value="<?php echo $get_iso['id'];?>" selected="selected" ><?php echo $get_iso['first_name'];?></option>
										<?php  
									}
							?>
                ...
                <input type="text" readonly="readonly"  class="form-control" name="temporary_iso_signdates[<?php echo $i; ?>]" id="temporary_iso_signdates[<?php echo $i; ?>]" style="margin-bottom:5px;width:100px;font-size:9px;"     value="<?php echo $temporary_iso_signdate; ?>"  />                                    
                                                    </TD>
                <TD class="tr7 td98"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td90"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td165">
                
                        <select <?php echo ($temp_disabled_re_pa!='') ? $temp_disabled_re_pa : ''; ?> style="width:100px;margin-top:5px;" id="temporary_re_pa[<?php echo $i; ?>]" name="temporary_re_pa[<?php echo $i; ?>]"  class="form-control temporary_re_pa<?php echo $i; ?> authority_sign temporary_re_pa" data-issuing-field="temporary_re_ia<?php echo $i; ?>" data-date-field="temporary_re_pa_signdates<?php echo $i; ?>" data-selection="pa" data-attr="<?php echo $i; ?>" >
                                      <option value="" selected="selected">- - Select - -</option>
                                      <?php
...
<br />
                ...
                <input type="text" readonly="readonly"  class="form-control temporary_re_pa_signdates<?php echo $i; ?>" name="temporary_re_pa_signdates[<?php echo $i; ?>]" id="temporary_re_pa_signdates[<?php echo $i; ?>]" 
                style="margin-bottom:5px;width:100px;font-size:9px;"     value="<?php echo $temporary_re_pa_signdate; ?>"  />
                
                </TD>
                <TD class="tr7 td110"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td111"><P class="p1 ft1">&nbsp;</P></TD>
                <TD class="tr7 td166" colspan="2"><P class="p1 ft1">&nbsp;</P>
                <?php
				
				if($temporary_re_pa=='')
				$temp_disabled_re_ia=$tmp_disabled;
				
				
				?>
                                   <select style="width:100px;margin-top:5px;" <?php echo ($temp_disabled_re_ia!='') ? $temp_disabled_re_ia : ''; ?>  id="temporary_re_ia[<?php echo $i; ?>]" name="temporary_re_ia[<?php echo $i; ?>]" class="form-control temporary_re_ia<?php echo $i; ?> authority_sign" data-selection="ia" data-attr="<?php echo $i; ?>">
                                                      <option value="">- - Select - -</option>
                                                      <?php
                                         if($issuing_authorities!='')
                                          {
...
<br />
                ...
                <input type="text" readonly="readonly"  class="form-control" name="temporary_re_ia_signdates[<?php echo $i; ?>]" id="temporary_re_ia_signdates[<?php echo $i; ?>]" style="margin-bottom:5px;width:100px;font-size:9px;"     value="<?php echo $temporary_re_ia_signdate; ?>"  />                                    

                </TD>
               
                <TD class="tr7 td101">
                
                                <select style="width:100px;margin-top:5px;"  id="temporary_re_iso[<?php echo $i; ?>]" name="temporary_re_iso[<?php echo $i; ?>]" class="form-control temporary_re_iso<?php echo $i; ?>" <?php echo ($temp_disabled_re_iso!='') ? $temp_disabled_re_iso : 'disabled="disabled"'; ?>>
                 <option value="" selected="selected">- - Select - -</option>
                    	<?php
                ...
                <input type="text" readonly="readonly"  class="form-control" name="temporary_re_iso_signdates[<?php echo $i; ?>]" id="temporary_re_iso_signdates[<?php echo $i; ?>]" style="margin-bottom:5px;width:100px;font-size:9px;"     value="<?php echo $temporary_re_iso_signdate; ?>"  />                                    
                ...
                <TABLE cellpadding=0 cellspacing=0 class="t1" id="table6" style="width:1024px;" align="center">
                    ...
                    <TR>
                        <TD class="tr8 td0"><P class="p1 ft12">&nbsp;</P></TD>
                        <TD colspan=3 rowspan=2 class="tr18 td139"><P class="p3 ft6">Name of the Performing Authority :</P>
	...
	?>                        
      ...
      ?>
       ...
       ?>
                        ...
                        <TD class="tr8 td172"><P class="p1 ft12">&nbsp;</P></TD>
                        <TD colspan=3 rowspan=2 class="tr18 td168"><P class="p3 ft6">Name of the Issuing Authority :</P>
<?php
...
<select <?php echo $ia_id3; ?> style="margin:5px;width: 165px;" id="issuing_authority_id3" name="issuing_authority_id3" class="form-control issuing authority" >
      ...
      ?>
       ...
       ?>
                                                    ...
                                                    <?php $dropdown_css='width:200px;margin:5px;';
													 ...
													 ?>
        <TD colspan=3 class="tr9 td178"><P class="p14 ft34">1. Electrical</P></TD>
	...
	<?php
				...
				if($performing_authority_id3>0)
				{
					  ...
					  {
						$department_completion_users_approval_date=date('Y-m-d H:i:');
	...
	?>          
        ...
        class="form-control department_completion_users" data-date-field="department_completion_users_approval_dates" data-attr="<?php echo EIP_ELECTRICAL; ?>" <?php echo $electrical_disable; ?> >
      <option value="" selected="selected">- - Select - -</option>
                                      <?php
       ...
       ?>
        ...
        <?php  $issuing_authority_id3_date=(isset($records['issuing_authority_id3_date'])) ? $records['issuing_authority_id3_date'] : '';
         ...
         <p><input readonly type="text" class="form-control" name="issuing_authority_id3_date" id="issuing_authority_id3_date" style="width:150px;margin:5px;" value="<?php echo $issuing_authority_id3_date; ?>"  /></p>                        
                        ...
                        <TD colspan=3 class="tr7 td178"><P class="p14 ft37">5. Process</P></TD>
...
?>
      ...
      ?>
       ...
       ?>
                                                  ...
                                                  <td class="tr7 td178">                      
                                                    <input type="text" readonly="readonly"  class="form-control temporary_pa_signdates<?php echo $i; ?>" name="department_completion_users_approval_dates[<?php echo EIP_PROCESS; ?>]" id="department_completion_users_approval_dates[<?php echo EIP_PROCESS; ?>]" 
                style="<?php echo $text_css; ?>"     value="<?php echo $department_completion_users_approval_date; ?>"  />                   
        </TD>
	...
	$department_user_validation = 0;
							...
							$submit_value='show';							
	#echo '<br /> A : '.$performing_authority_id2_approval.' - '.$user_id.' == '.$remarks_issuing_id;
		  if($eip_id!='' && $approval_status!=11) #$approval_status!=8
		  {
			  ...
			  else if($issuing_authority_id2_approval=='No' && $user_id==$issuing_authority_id2)
			  {
				  $label=' Approve & Submit';
		 ...
		 # echo '<br /> Show Flag : '.$show_flag.' - '.$label.' - '.$issuing_authority_id3_approval.' - '.$user_id.' == '.$issuing_authority_id3;
...
<script type="text/javascript">
		...
		for($i=2;$i<=10;$i++)
		{
			...
			$validate.=",'isolate_types[".$i."]':{required:function(element) {
				...
				else if($approval_status==3)
				{
						if($show_flag==3)
						{								 
							$validate.=",'isolated_tagno3[".$i."]':{required:true}";	
							$validate.=",'isolated_tagno4[".$i."]':{required:true}";	
						}
				}
		 ...
		 ?>
			...
			rules: {
				...
				'isolated_tagno4[1]' : { required: <?php echo $flag; ?> },
				...
				<?php echo $validate;
					...
					if(in_array($approval_status,array(8,6)))
					{
						...
						echo ",'department_completion_users[".$eip_completed_departments[$e]."]':
					      { required:function(element)
						         { 
								 	//alert('vvv '+$(this).children('option').length);
								 	//alert('vvv '+$('select[name=\"department_completion_users[".$eip_completed_departments[$e]."]\"]').children('option').length);
									var cnt=$('select[name=\"department_completion_users[".$eip_completed_departments[$e]."]\"]').children('option').length;
								  	if($('#performing_authority_id3').val()!='' && cnt>1)
									return true;
									else
									return false;								  	
								  }
					...
					$.ajax({
							...
							success: function(data, textStatus, jqXHR)
							{
								...
								///alert(data); return false;
									...
									opt='<option value="'+data_id+'"  selected="selected">'+$('#section').val()+'(#'+data_id+')</option>';
	...
	$('.authority_sign').change(function()
	{
		...
		$('.temporary_pa_signdates'+data_attr).val(ShowLocalDate());
		
		$('.temporary_pa_signdates'+data_attr).val('');*/
		//alert(date_field+' - '+data_attr+ ' - '+data_selection);
		...
		/*if(val!='' && associate_value!='')
		{
			if(val==associate_value)
			{
				alert('PA & IA should not be same member');
	...
	$('.temporary_re_pa').change(function() 
	{
		var data_attr=$(this).attr('data-attr');
		...
		$('.temporary_re_iso'+data_attr).html('<option value="" selected>Select</option>');
		...
		data_iso_name=$('.data-iso-name'+data_iso+' option:selected').text();
			...
			if(val!='')
			{
				...
				$('.temporary_re_iso'+data_attr).html('<option value="'+data_iso+'" selected>'+data_iso_name+'</option>');
			}
	...
	$('.temporary_tags').change(function() 
	{
		...
		else
		{
			...
			var t=$('.temporary_tags').filter(function () {
				...
				//alert('Loop : '+$('#allow_equip'+this.value).html());
				if(this.value!='')
    			return !!this.value;
			}).length;
	...
	$('.generate_date').change(function() {
				...
				else
				{
					...
					//document.getElementById(issue_id).selectedIndex = -1;
