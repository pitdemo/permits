...
$eip_yes_selection='';
	...
	$table.='<tr><td style="border:1px solid #ccc;vertical-align:top"rowspan="6" colspan="2"><table style="width:100%;height:100%; border-collapse:collapse"><tr><td style="border-bottom:1px solid #ccc;border-right:0px solid #ccc; vertical-align:top;text-align:left;height:30px;" colspan="2"><b>Description of Job</b> <br /> '.$job_name.'</td>
				...
				<tr>					
					...
					<p><b>Is EIP obtained</b><input type="radio" '.$yes_active.'>Yes&nbsp;<input type="radio" '.$yes_existing_active.'>Yes&Existing&nbsp;<input type="radio" '.$no_active.'>Existing&nbsp;<input type="radio" '.$na_active.'>No</p><br />
...
I have ensured that each of the identified control measures is suitable. The content of the permit hasbeen explained to the holder and work may proceed. </td>
		<td style="border:1px solid #ccc;border-right:0px solid #ccc;"colspan="6">I have inspected the work area and declare the work for whih the permit was issued has been properly performed</td>
	</tr>';
...
$acceptance_issuing_date=(isset($records['acceptance_issuing_date']) && $records['acceptance_issuing_date']!='') ? date('d-m-Y H:i',strtotime($records['acceptance_issuing_date'])).$hrs : ''; 
  ...
  if($authorities!='')
  {
	...
	$table.='<tr>
		...
		<td style="border-left:1px solid #ccc;border-right:0px solid #ccc;"colspan="3">Name : <strong>'.$cancellation_issuing_name.'</strong></td>
