...
$table.='<table style="font-family:Arial, Helvetica, sans-serif;width:100%;font-size:8.5px !important; border: 1px solid #000000;	margin:0 auto;border-collapse:collapse;margin-top:550px;"  align="center">
    <colgroup>
        <col width="5%"><col width="5%">
        <col width="5%"><col width="5%">
        <col width="5%"><col width="5%">
   ...
   $table.=' <tr style="border:1px solid #ccc;" >
	...
	<img src="'.base_url().'/assets/img/Checklist2.png" style="width:550px;vertical-align:top;" ></td></tr></table><pagebreak />';
