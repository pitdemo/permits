...
<table style="font-family:Arial, Helvetica, sans-serif;width:100%;width:100%;font-size:8.5px !important; border: 0px solid #000000;	margin:0 auto;border-collapse:collapse;"  align="center">
	...
	<tr>
		...
		<td style="border:1px solid #ccc;" colspan="4" ><strong>Hazards / concersn identified:</strong></td>
...
$eip_yes_selection='';
	  ...
	  $na_active=$checked;
	$table.='<tr><td style="border:1px solid #ccc;vertical-align:top"rowspan="6" colspan="2"><table style="width:100%;height:100%; border-collapse:collapse"><tr><td style="border-bottom:1px solid #ccc;border-right:1px solid #ccc; vertical-align:middle;text-align:left;height:30px;">Location</td>
					<td style="text-align:left;border-bottom:1px solid #ccc;border-right:0px solid #ccc; vertical-align:middle;"> '.$location.'</td></tr>
				...
				<tr>					
					...
					<p><b>Is Energy Isolation permit obtained</b><input type="radio" '.$yes_active.'>Yes&nbsp;<input type="radio" '.$no_active.'>Existing&nbsp;<input type="radio" '.$na_active.'>No</p><br />
 ...
 $haz=(isset($hazards->e)) ? strtoupper($hazards->e) : '';	
	...
	$table.='<tr>
	<td style="border:1px solid #ccc;vertical-align:middle;"colspan="4">		e) Excessive Temparature </td>
		<td style="border: 1px solid #cccccc;vertical-align:middle;" align="center">'.$haz.'</td>
		<td style="border:1px solid #ccc;"colspan="5">      
 ...
 $haz=(isset($hazards->i)) ? strtoupper($hazards->i) : '';	
	...
	$table.='<tr>
		...
		<td style="border:1px solid #ccc;"colspan="5">      
				i) Loose materials removed & barrier provided
		<td style="border:1px solid #cccccc;" align="center">'.$pre.'</td>
	</tr>';
...
$wopn=(isset($watch_other_person_names[2])) ? strtoupper($watch_other_person_names[2]) : '';
	...
	<td style="border:1px solid #ccc;"><strong>Oxygen </strong> </td>
		...
		<td style="border:1px solid #ccc;"colspan="6">I have had permit explined shall work in accordance with the control measures identified</td>
		<td style="border:1px solid #ccc;"colspan="6">Work completed, all persons are withdrawn and material removed from the area.</td>
	</tr>';
  ...
  if($authorities!='')
  {
	...
	Digital Sign/Date&Time: <b>'.$acceptance_performing_date.'</b></td>
		...
		<td style="border:1px solid #ccc;"colspan="3">Digital Sign/Date&Time: <b>'.$cancellation_performing_date.'</b></td>
	</tr>	
	<tr>
...
I have ensured that each of the identified control measures is suitable. The content of the permit hasbeen explained to the holder and work may proceed. </td>
		<td style="border:1px solid #ccc;"colspan="6">I have inspected the work area and declare the work for whih the permit was issued has been properly performed</td>
	</tr>';
...
$acceptance_issuing_date=(isset($records['acceptance_issuing_date']) && $records['acceptance_issuing_date']!='') ? date('d-m-Y H:i',strtotime($records['acceptance_issuing_date'])).$hrs : ''; 
  ...
  if($authorities!='')
  {
	...
	$table.='<tr>
		...
		<td style="border-top:1px solid #ccc;border-left:1px solid #ccc;"></td>
		<td colspan="4" style="border-left:1px solid #ccc;">Name : <strong>'.$acceptance_issuing_name.'</strong></td>
		<td colspan="2" style="border-left:1px solid #ccc;">Sign/Date&Time: <strong>'.$acceptance_issuing_date.'</strong></td>
		<td style="border-left:1px solid #ccc;"colspan="3">Name : <strong>'.$cancellation_issuing_name.'</strong></td>
		<td style="border-left:1px solid #ccc;" colspan="3">Digital Sign/Date&Time: <strong>'.$cancellation_issuing_date.'</strong></td> 
	</tr>';
  ...
  if($safety_authorities!='')
  {
	...
	$table.='<tr>
		...
		<td style="border:1px solid #ccc;"colspan="12">I have visited the work area and checked the oxygen leve, found it well within the requirement of this permit and the readings are as follows:</td></tr>';
	...
	<table style="border-collapse:collapse;padding:0px;" width="100%" align="center">
	<tr>		
...
<tr>
	...
	foreach($extended_ranges as $extended_range)	
	{
		...
		if($extended_range=='a')
		{
			...
			$ia_td='<td style="border: 1px solid #cccccc;">'.$to_ia_name.'</td>';
		...
		else
		{
			...
			$ia_td.='<td style="border: 1px solid #cccccc;">'.$from_ia_name.'</td><td style="border: 1px solid #cccccc;">'.$to_ia_name.'</td>';	
...
<tr><td style="border: 1px solid #cccccc;" colspan="3">Ref Code</td>'.$ref_td.'
	...
	<tr>
	<td colspan="13" style="border:1px solid #ccc;font-size: 10px !important;"><strong>Emergeny contac number : cell : 9865152222/ 3108 / PA system 9 Ref No: WI-33(P1-14:AM 7) Rev No: 01 Dt. 30.06.2016</strong></td> </tr>
</table></body></html>';
#echo $table; exit;
