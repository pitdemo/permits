...
<div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <?php $this->load->view('layouts/msg'); $this->load->view('layouts/marquee'); $status_arr=array('PA'=>'Performing Authority','IA'=>'Issuing Authority','SAT'=>'Safety Authority','All'=>'All'); $active=''; ?>
    ...
    $('#myTab a').click(function (e)
     {
      ...
      url: base_url+'confined_permits/ajax_fetch_data/'+params_url
