...
$status=$eip_opened='';
 ...
 #echo '<pre>'; print_r($authorities); exit;
?>
...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  ?>
   ...
   <table cellspacing="0" border="0" width="100%" align="center" class="form_work">
             <tr height=36 style='height:27.0pt'>
                            <td style="border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20;width:0px;" colspan=3 height="30" align="left" width="500px" valign=top><b>Select Department </b>
                  ...
                  if($zones->num_rows()>0)
                     ...
                     $zones=$zones->result_array();
                      ...
                      ?>
                              ...
                              <td style="border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20" colspan=3 height="30" align="left" valign=top><b>CSE Location Number</b>
                              
                              <input type="text" class="form-control" name="cse_location_no" id="cse_location_no" value="<?php echo (isset($records['cse_location_no'])) ? $records['cse_location_no'] : ''; ?>"  />

                              </td>
                             
                               <td style="border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20;padding-right:5px;" colspan=12 height="30" align="right" width="500px" valign=top>

                               <b>Permit No</b><br />#<span id="permit_no"><?php echo (isset($records['permit_no'])) ? $records['permit_no'] : $permit_no; ?></span>
  ...
  <tr>
    ...
    <td style="border-top: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20" colspan=3 align="left" valign=top><b>Date To </b><br><input type="text" readonly="readonly" class="form-control" name="location_time_to" id="location_time_to" style="width:175px;" value="<?php echo (isset($records['location_time_to'])) ? $records['location_time_to'] : date('d-m-Y H:i',strtotime($system_current_date."+12 hours")); ?>" />      </td>
...
?>              
  ...
  <tr>
    ...
    <td style="border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20" align="left" valign=top><center>
                            <input name="hazards[i]" data-attr="i" data-checkbox='true' <?php if(isset($hazards->i) && $hazards->i=='Yes') { ?> checked="checked" <?php } ?> type="radio"  class="radio_button hazards" value="Yes" />
                              ...
                              N&nbsp;</center></td>
    <td style="border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20" colspan=6 align="left" valign=top>i)  loose material removed / barrier provided / safety net tied / dummy provided</td>
    <td style="border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20" colspan=2 align="left" valign=top><center>
 ...
 <div class="inc"`  style="height:200px;overflow:scroll;">
  ...
  ?>  
   ...
   <table cellpadding=0 cellspacing=0>
    ...
    width:111pt'>
                                   ...
                                   <td height=35 class=xl76  colspan="3" style='height:26.25pt;border-top:none;
    width:111pt'> <input type="checkbox" name="required_ppe[]" class="required_ppe"  value="Fall Protection Kit" <?php if(in_array('Fall Protection Kit',$required_ppe)) { ?> checked="checked" <?php } ?>/>&nbsp; Fall Protection Kit
...
<?php echo $self_cancellation_description; ?>
  ...
  ?>                               
    <td style="padding-left:5px; border-top: 1px solid #231f20; border-bottom: 1px solid #231f20; border-left: 1px solid #231f20; border-right: 1px solid #231f20" colspan=3 align="left" valign=top><font face="Verdana" size=1>Date:</font><input type="text" value="<?php echo $sch_date; ?>" name="schedule_date[<?php echo $extended_range; ?>]"  class="schedule_date form-control" style="width: 107px;" data-alpha-id="<?php echo $extended_range; ?>" id="schedule_date<?php echo $er; ?>" data-id="<?php echo $er; ?>" data-diff="<?php echo $diff_days; ?>" data-sa-approval="<?php echo $ext_sa_app_status; ?>" data-ia-approval="<?php echo $ia_app_status; ?>" /></td>
    <?php
      $er++;
   }
...
<br /><p><b>Name of IA</b></p>
  <?php
   ...
   if($issuing_authority==$user_id && $issuing_approval_status!='Approved' && $permission==READ)
   $show_name_of_ia='';

  ?>  
 <input type="text" <?php echo $show_name_of_ia; ?> name="extend_issuing_authority_name_of_to_ia[a]" id="extend_issuing_authority_name_of_to_ia[a]" class="form-control" value="<?php echo (isset($extend_issuing_authority_name_of_to_ia->a)) ? $extend_issuing_authority_name_of_to_ia->a : ''; ?>"/><br />
  </td>
  ...
  ?>  
 <input type="text" <?php echo $show_name_of_ia; ?> name="extend_issuing_authority_name_of_from_ia[<?php echo $extended_range; ?>]" id="extend_issuing_authority_name_of_from_ia[<?php echo $extended_range; ?>]" class="form-control issuing_authority" value="<?php echo (isset($extend_issuing_authority_name_of_from_ia->$extended_range)) ? $extend_issuing_authority_name_of_from_ia->$extended_range : ''; ?>"/><br />
 ...
 <br /><p><b>Name of IA</b></p>
  ...
  ?>  
 <input type="text" <?php echo $show_name_of_ia; ?> name="extend_issuing_authority_name_of_to_ia[<?php echo $extended_range; ?>]" id="extend_issuing_authority_name_of_to_ia[<?php echo $extended_range; ?>]" class="form-control issuing_authority" value="<?php echo (isset($extend_issuing_authority_name_of_to_ia->$extended_range)) ? $extend_issuing_authority_name_of_to_ia->$extended_range : ''; ?>"/><br />
...
<input type="hidden" id="show_button" name="show_button" />
            ...
            $show_extend_field=-01;$show_flag=0;$redirect=''; $show_button=false; $enable_extend_inputs=$exten_time_period=$ext_range=$cancel_ia='';
            
            $draft=NO; $submit_value='show'; 
           ...
           # echo '<br /> S : '.$is_show_button.' = '.$show_flag.' - '.$approval_status;
            ...
            if(empty($record_id))
            {
                ...
                echo '<button class="btn btn-sm btn-primary show_button" id="submit"  value="show" type="submit"><i class="fa fa-dot-circle-o"></i> Create</button>';
            }
            else
            {
                if($approval_status<13  && $draft==NO)
                {
                  if($is_show_button=='show')
                  {
                      ...
                      else if($acceptance_issuing_approval=='No' && $user_id==$records['acceptance_issuing_id'] && $acceptance_safety_approval=='Yes')
                      {
                        ...
                        if($job_status_error_msg!=''  && $draft_user_id=='')
                        $show_flag='';
                        else                  
                        { $show_flag=3; $show_button=true; }          
                  ...
                  else   //After Final Submit
                  {
                      ...
                      else
                      {
                        ...
                        for($r=0;$r<count($range);$r++)
                        {
                          ...
                          $ext_name_of_from_ia=$ext_name_of_to_ia='';
                                      ...
                                      if($extended_safety_to_approval_status[$range[$r]]==WAITING || $extended_issuing_to_approval_status[$range[$r]]==WAITING)
                                      {
                                        $ex='';
                                          ...
                                          if($extended_issuing_to_authority[$range[$r]]==$user_id && $ex=='')
                                          {
                                            if($extended_issuing_to_approval_status[$range[$r]]==WAITING)
                                            {
                                              ...
                                              $ex='IA';
                                               if($permission==READ)
                                               {                                             
                                                   $ext_range=$range[$r]; $ext_name_of_to_ia=$extended_issuing_to_authority[$range[$r]]; 
                                               }
                                            }
                                          } 

                                          #echo 'FF '.$ex.' = '.$extended_safety_to_approval_status[$range[$r]].' = '.$extended_issuing_to_approval_status[$range[$r]];

                                          #echo ' PA ID '.$extended_performing_to_authority[$range[$r]].' = '.$user_id;
                                          ...
                                          if($ex!='')
                                          {
                                             ...
                                             echo '<button class="btn btn-sm btn-primary show_button"  id="submit" value="hides" type="submit"><i class="fa fa-dot-circle-o"></i> Approve  '.$ex.' '.$status.' & Submit</button>';  
                                                   break;
                                          }
                                          $ex='PA';  
                                            ...
                                            if($extended_issuing_from_authority[$range[$r]]==$user_id && $ex=='') 
                                            {
                                              ...
                                              { 
                                                ...
                                                $is_extended_ia_approval=2; 
                                                 ...
                                                 if($permission==READ)
                                                 {                                             
                                                     $ext_range=$range[$r]; $ext_name_of_from_ia=$extended_issuing_from_approval_status[$range[$r]]; 
                                                 }
                                              } 
                                            } 
            ...
            <?php if($approval_status<4 || $record_id=='') { ?>
...
function generate_time($array_args)
{
  ...
  $width=(isset($width)) ? $width : '103px';
  
  $class=(isset($class)) ? $class : '';
  
  $id=(isset($id)) ? $id : $name;

  $default_time = (isset($default_time)) ? $default_time : '';

  $data_ia_approval = (isset($data_ia_approval)) ? $data_ia_approval : '';
    #if($selected_value=='')
    #$selected_value=$default_time;
?>  
  <select name="<?php echo $name; ?>" id="<?php echo $id; ?>" data-time-field="<?php echo $data_time_field; ?>" data-time-attr="<?php echo $data_time_attr; ?>"  class="form-control <?php echo $class; ?>" data-id="<?php echo $data_id; ?>" 
    data-ia-approval="<?php echo $data_ia_approval; ?>" style="width:<?php echo $width; ?>;">
      <option value="" selected="selected">Select</option>
  <?php for($i = 0; $i < 24; $i++)
    {
...
<script type="text/javascript">   
  ...
  {   
                     ...
                     console.log('SA Approral '+sa_approval_status+ ' Extended time period '+ia_approval_status+ ' = = = Data ID '+data_id+' ]]]'+'.extended_safety_'+extend_time_period+'_approval_status'+data_id);
                      ...
                      else if($(this).val()!='' && (sa_approval_status=='Waiting' && ia_approval_status==''))
                      {
                          if(confirm('Are you sure going to change status?'))
                          {
                              ...
                              $('.watch_person_'+extend_time_period+data_id).prop('disabled',true);

                              $('.watch_other_person_'+extend_time_period+data_id).val('');

                              $('.watch_other_person_'+extend_time_period+data_id).prop('disabled',true);

                              $('.schedule_'+extend_time_period+data_id).val('');

                              $('.schedule_'+extend_time_period+data_id).prop('disabled',true);


                              $('.extended_pa_'+extend_time_period+data_id).val('');

                              $('.extended_pa_'+extend_time_period+data_id).prop('disabled',true);

                              $('.extended_sa_'+extend_time_period+data_id).val('');

                              $('.extended_sa_'+extend_time_period+data_id).prop('disabled',true);

                              $('.extended_ia_'+extend_time_period+data_id).val('');

                              $('.extended_ia_'+extend_time_period+data_id).prop('disabled',true);
              ...
              else
              {
                ...
                $('input[name^="schedule_date"]').each(function()
                {
                  ...
                  acceptance_issuing_date=$('#schedule_date'+(d-1)).val();  
                    ...
                    var date_selected=$('#schedule_date'+(parseInt(data_id)-1)).val();

                    var ia_approval=$('#schedule_date'+(parseInt(data_id)-1)).attr('data-ia-approval');

                    var sa_approval=$('#schedule_date'+(parseInt(data_id)-1)).attr('data-sa-approval');

                    var time_period = $('.extended_time_period'+(parseInt(data_id)-1)).val();  
                  
                    var pa_id=$('.extended_pa_'+time_period+''+(parseInt(data_id)-1)).val();  
                    ...
                    {   
                        ...
                        { 
                            ...
                            if(pa_id=='<?php echo $user_id; ?>' && date_selected!='')
                            {

                                var rr=0;

                                if(ia_approval!='Approved')
                                {
                                  $('.extended_ia_'+time_period+(parseInt(data_id)-1)).prop('disabled',false);

                                  rr++;

                                }

                                if(sa_approval!='Approved')
                                {
                                  $('.extended_sa_'+time_period+(parseInt(data_id)-1)).prop('disabled',false);
                                ...
                                if(rr>=1)
                                {
                                    $('.watch_other_person_'+time_period+(parseInt(data_id)-1)).prop('disabled',false);

                                    $('.watch_person_'+time_period+(parseInt(data_id)-1)).prop('disabled',false);

                                    $('.schedule_'+time_period+(parseInt(data_id)-1)).prop('disabled',false);
                                }
      ...
      $disable_all="$('input,select').attr('disabled',true);";
       ...
       if(in_array($user_id,array($ext_name_of_to_ia,$ext_name_of_from_ia)) && $permission==READ)
       {  
              $ia_f='to';

              if($user_id==$ext_name_of_from_ia)  
                $ia_f='from';

       echo "$('input[name=\"extend_issuing_authority_name_of_".$ia_f."_ia[".$ext_range."]\"]').removeAttr('disabled');";
       }
      ...
      if(!empty($record_id))
      {
        ...
        for($i=0;$i<count($arr);$i++)
        {
          ...
          $validate.=",'extend_issuing_authority_name_of_to_ia[".$arr[$i]."]':{required:true}";   
          
          $validate.=",'extend_issuing_authority_name_of_from_ia[".$arr[$i]."]':{required:true}";                                           
        ...
        $(".btn-danger").attr('disabled',true);   
          ...
          $.ajax({
                  ...
                  success: function(data, textStatus, jqXHR)
                  {
                      ...
                      {
                        window.location.href=base_url+'confined_permits/form/id/'+$('#id').val();
                      }
                      else
                      {
                          if(data.print_out!='')
