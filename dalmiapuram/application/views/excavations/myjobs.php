                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-12">
                            <!--breadcrumbs start -->
                            <ul class="breadcrumb">
                                <li ><a href="javascript:void(0);"><i class="fa fa-home"></i>Excavations</a></li>
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <section class="panel">
                                       <div class="panel-body ">
                                        ...
                                        <?php $this->load->view('layouts/msg');  $status_arr=array('PA'=>'Performing Authority','IA'=>'Issuing Authority','dept'=>'Dept Clearance'); $active=''; ?>
          					  ...
          					  <div id="myTabContent" class="tab-content">
                                  ...
                                  <thead>
                                    <tr>
                                       ...
                                       <!-- <th data-field='waiating_approval_by' class="center" width="75px">Waiting Approval</th>
