...
<form id="job_form" name="job_form" enctype="multipart/form-data" > 
  ...
  1) All excavation above one water Depth<br>
...
<input type="hidden" style="width:150px;" value="<?php echo (isset($dept_approval_status->d)) ? $dept_approval_status->d : ''; ?>"  name="dept_approval_status[d]" class="form-control" readonly="readonly" />
  ...
  <tr>
    <td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-right: 1px solid #231f20" colspan=6 align="left" valign=top>2) Underground Fire Hydrant line at <input type="text"  name="m_depth[e]" id="saf_depth"  value="<?php echo (isset($m_depth->e)) ? $m_depth->e : ''; ?>" <?php echo $disabled; ?>> m depth</td>
  </tr>
  
  
  <tr>
    <td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-right: 1px solid #231f20" colspan=6 align="left" valign=top>Excavation to be done by Manual : <input type="text" name="manual_done" id="manual_done" value="<?php echo (isset($records['manual_done'])) ? $records['manual_done'] : ''; ?>" <?php echo $disabled; ?>> Powerd : <input type="text" name="powered" id="powered" value="<?php echo (isset($records['powered'])) ? $records['powered'] : ''; ?>" <?php echo $disabled; ?>></td>
  </tr>
...
<td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-left: 0px solid #231f20; border-right: 1px solid #231f20" align="left" valign=top><center>
  ...
  ?>   
  <tr>
    <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=2 rowspan=4 height="" align="left" valign=top><b>Instrument Department:</b> <br>
...
<td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-left: 0px solid #231f20; border-right: 1px solid #231f20" align="left" valign=top><center>
  ...
  <tr>
    <td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-right: 0px solid #231f20" colspan=5 align="left" valign=top>5)Arrangements made for shoring /shuttering</td>
<td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-left: 0px solid #231f20; border-right: 1px solid #231f20" align="left" valign=top><center>
