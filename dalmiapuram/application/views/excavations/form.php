...
<br>
  ...
  <div class="col-sm-9"><b>Remarks (If any):</b><br />
    <textarea name="dept_remarks[d]" class="form-control" rows="5" cols="30" <?php echo $disabled; ?>><?php echo (isset($dept_remarks->d)) ? $dept_remarks->d : ''; ?></textarea>
  </div>
...
<input type="hidden" style="width:150px;" value="<?php echo (isset($dept_approval_status->d)) ? $dept_approval_status->d : ''; ?>"  name="dept_approval_status[d]" class="form-control" readonly="readonly" />
 ...
 $cable_deductor = isset($records['cable_deductor']) ? $records['cable_deductor'] : '';
  ...
  ?>
  <tr>
    <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" colspan=2 rowspan=9 height="" align="left" valign=top><b>Electrical & Instrumentation Department: </b><br>
  1) Underground Electrical cables are passing through the area <span style="float:right;"><input type="radio"  name="precautions[b]" class="radio_button precautions" data-checkbox="true" data-attr="b" value="Yes" <?php if(isset($precautions->b) && $precautions->b=='Yes') { ?> checked="checked" <?php } ?>  <?php echo $disabled; ?>/>
                              Y&nbsp;
                              ...
                              N&nbsp;</span><br>
    2) Underground Electrical Cables at <input type="text"  name="m_depth[b]" id="el_depth" value="<?php echo (isset($m_depth->b)) ? $m_depth->b : ''; ?>" <?php echo $disabled; ?>> m depth<br>
    3) Excavated work space area inspected with live cable deductor <input type="radio"  name="cable_deductor" class="radio_button precautions" data-checkbox="true" data-attr="b" value="Yes" <?php if(isset($cable_deductor) && $cable_deductor=='Yes') { ?> checked="checked" <?php } ?>  <?php echo $disabled; ?>/>
                              Yes&nbsp;
                              <input type="radio" <?php if(isset($cable_deductor) && $cable_deductor=='No') { ?> checked="checked" <?php } ?> class="radio_button precautions"  name="cable_deductor" data-attr="b" value="No" data-checkbox="true" <?php echo $disabled; ?>/>No
                              <br>
  <br>
  <div class="col-sm-9"><b>Remarks (If any):</b><br />
    <textarea name="dept_remarks[b]" class="form-control" rows="8" cols="40" <?php echo $disabled; ?> ><?php echo (isset($dept_remarks->b)) ? $dept_remarks->b : ''; ?></textarea>
  </div>

  
  <div class="col-sm-6 " style="padding-top:50px;"><b>Name</b>

            <select id="el_dept_issuing_id" <?php if($d_approval_status=='Yes') { ?> disabled="disabled" <?php } ?> name="dept_issuing_id[b]"  class="form-control authority performing dept_issuing_id">
                  <option value="" selected="selected">- - Select - -</option>
                  <?php
                  ...
                  if($authorities!='')
                  {
                    foreach($authorities as $fet)
                    {
                      ...
                      if($flag==1 && $fet['department_id']==EIP_ELECTRICAL_INSTRUMENTAL)
                      {
                          if($dept_issue_id==$id) $chk='selected';
                  ?>
                          <option value="<?php echo $id; ?>" <?php echo $chk; ?>><?php echo $first_name; ?></option>
  ...
  </div><div class="col-sm-6" style="padding-top:50px;"><b>Digital Sign/Date & Time</b>
<input type="text" style="width:150px;" value="<?php echo (isset($dept_issuing_date->b)) ? $dept_issuing_date->b : ''; ?>"  
name="dept_issuing_date[b]" class="form-control" readonly="readonly" />
...
<td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-left: 0px solid #231f20; border-right: 1px solid #231f20" align="left" valign=top><br /><center>
 ...
 <tr>
    <td style="border-top: <?php echo $border_top; ?>; border-bottom:<?php echo $border_bottom; ?>; border-right: 1px solid #231f20" colspan=6 align="left" valign=top>
      <br />
      <div class="col-sm-9"><b>Remarks (If any):</b><br />
    <textarea name="dept_remarks[e]" class="form-control" rows="5" cols="30" <?php echo $disabled; ?>><?php echo (isset($dept_remarks->e)) ? $dept_remarks->e : ''; ?></textarea><br /> 
  </div>
...
<input type="hidden" style="width:150px;" value="<?php echo (isset($dept_approval_status->e)) ? $dept_approval_status->e : ''; ?>"  name="dept_approval_status[e]" class="form-control" readonly="readonly" />
  ...
  1) Underground IT cables are passing through the area <span style="float:right;"><input type="radio"  name="precautions[c]" class="radio_button precautions" data-checkbox="true" data-attr="c" value="Yes" <?php if(isset($precautions->c) && $precautions->c=='Yes') { ?> checked="checked" <?php } echo $disabled; ?> />
    ...
    2) Underground IT Cables at <input type="text"  name="m_depth[c]" id="it_depth" value="<?php echo (isset($m_depth->c)) ? $m_depth->c : ''; ?>" <?php echo $disabled; ?>> m depth<br><br>
      ...
      <div class="col-sm-9"><b>Remarks (If any):</b><br />
    <textarea name="dept_remarks[c]" class="form-control" rows="5" cols="30" <?php echo $disabled; ?>><?php echo (isset($dept_remarks->c)) ? $dept_remarks->c : ''; ?></textarea>
  </div>
...
$('#contractor_id').change(function() {
    ...
    $("#job_form").validate({ 
      ...
      rules: {
        ...
        cable_deductor:{ required:<?php echo $flag; ?>},
      ...
      messages:
      {
        ...
        cable_deductor:{required:'Required' },
