...
<div class="wrapper row-offcanvas row-offcanvas-left">
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-md-12">
                            <!--breadcrumbs start -->
                            <ul class="breadcrumb">
                                <li ><a href="javascript:void(0);"><i class="fa fa-home"></i>Excavation</a></li>
                                <li class="active"><a href="javascript:void(0);">Day End Process</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
           ...
           <?php $this->load->view('layouts/msg'); $this->load->view('layouts/marquee'); ?>  
						           ...
						           data-toggle="table"
					               data-url="<?php echo base_url().$this->data['controller']; ?>ajax_fetch_data/show_button/hide/<?php echo (isset($params_url)) ? $params_url : ''; ?>"
              ...
              <thead>
                <tr>
                  ...
                  <th data-field='waiating_approval_by' class="center" width="75px">Waiting for approval</th>
...
<script>
	...
	$(document).ready(function()
	{
		$('body').on('click','.reset',function() 
		{
				...
				window.location='<?php echo base_url().$this->data['controller'];?>day_in_process';	
		});
		...
		$('.search_data').click(function()
		{
				...
				//if(form_id=='all')
				var params_url='show_button/hide/';
				...
				//Pushing values in Query Parameters
				  $('form#'+form_id+'_form').find(':input[type=hidden],select,:input[type=text]').each(function ()
				  {
						...
						method:'post',
						url: '<?php echo base_url().$this->data['controller'];?>ajax_fetch_data/'+params_url
						});		
