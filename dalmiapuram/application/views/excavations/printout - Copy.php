...
<table style="font-family:Arial, Helvetica, sans-serif;width:100%;width:100%;font-size:8.5px !important; border: 0px solid #000000;	margin:0 auto;border-collapse:collapse;"  align="center">
    ...
    $table.='<tr><td style="border-left:1px solid #ccc;padding-top:10px;" valign="top" width="50%"><table align="center" width="100%" ><tr><td align="left">
    	...
    	<tr><td colspan="2" align="left"  style="'.$padding_top.'">1) All excavation above one water Depth <br />2) Road Concreate Breaking</td></tr>';

    $desc=(isset($records['job_name'])) ? strtoupper($records['job_name']) : '';
    

    $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'"><b>Description of Work</b> <br />'.$desc.' <br /><br /><b>Permit Issued to</b></td></tr>';
	  ...
	  $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'border-top:1px solid #cccccc;"><b>Electrical Department:</b></td></tr>';

  $yes_active='';
  $no_active='';
  if(isset($records))
  {
	  $pre=(isset($precautions->a)) ? $precautions->a : '';
  ...
  $depth=(isset($m_depth->a) && $m_depth->a!='') ? '<b>'.$m_depth->a.'</b>' : '&nbsp;';	
	  ...
	  $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'">2) Underground Electrical Cables at <u>'.$depth.'</u> m depth</td></tr>';


  $dept_issue_id=(isset($dept_issuing_id->a)) ? $dept_issuing_id->a : '';
  $dept_date=(isset($dept_issuing_date->a)) ? $dept_issuing_date->a : '';
  $name='';
  if($authorities!='')
  {
 ...
 $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'border-top:1px solid #cccccc;"><b>Instrument Department:</b></td></tr>';
  ...
  $depth=(isset($m_depth->b) && $m_depth->b!='') ? '<b>'.$m_depth->b.'</b>' : '&nbsp;';	
	  ...
	  $table.='<tr><td align="left" style="'.$padding_top.'">1) Underground Instrument cables are passing through the area</td><td align="right"><input type="radio" '.$yes_active.'>Yes&nbsp;<input type="radio" '.$no_active.'>No</td></tr>';

	  $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'">2) Underground Instrument Cables at <u>'.$depth.'</u> m depth</td></tr>';
...
$table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'border-top:1px solid #cccccc;"><b>IT Department:</b></td></tr>';
  ...
  $depth=(isset($m_depth->c) && $m_depth->c!='') ? '<b>'.$m_depth->c.'</b>' : '&nbsp;';	
	  ...
	  $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'">2) Underground IT Cables at <u>'.$depth.'</u> m depth</td></tr>';
...
$yes_active='';
  ...
  $depth=(isset($m_depth->d) && $m_depth->d!='') ? '<b>'.$m_depth->d.'</b>' : '&nbsp;';	
	  ...
	  $table.='<tr><td colspan="2" align="left"  style="'.$padding_top.'">2) Underground Pipe Line at <u>'.$depth.'</u> m depth</td></tr>';
...
$table.='<tr><td align="left" style="'.$padding_top.'">5)Arrangements made for shoring /shuttering</td><td align="right"><input type="radio" '.$yes_active.'>Yes&nbsp;<input type="radio" '.$no_active.'>No</td></tr>';	  
  ...
  if($authorities!='')
  {
	  ...
	  <table align="center" width="100%">
	  	...
	  	<tr><td colspan="2" align="left"  style="'.$padding_top.'">&nbsp;</td></tr>
  	...
  	$table.='<td align="left"><b>Name </b><br />'.$name.'</td></tr>';

  	 $dept_date=(isset($records['acceptance_performing_date'])) ? $records['acceptance_performing_date'] : '';

  	$table.='<tr><td align="left" style="'.$padding_top.'"><b>Digitally Signed/Date&Time </b><br />'.$dept_date.'</td>';

  	$dept_date=(isset($records['acceptance_issuing_date'])) ? $records['acceptance_issuing_date'] : '';


  	$table.='<td align="left" valign="top" style="'.$padding_top.'"><b>Digitally Signed/Date&Time </b><br />'.$dept_date.'</td>';
