<div  class="modal fade" id="show_records_modal">
  ...
  <form method="post"  enctype="application/x-www-form-urlencoded">
    ...
    <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="attached_image">Attached Image</h4>
              </div>
              <div class="modal-body">              	
              	...
              	<div id="show_pdf_information" class="wall">
                    <!-- <img src="" alt="Attached Image" class="show_image"/> -->
