...
$other_inputs=(isset($records['other_inputs'])) ? explode(',',rtrim($records['other_inputs'],',')) : array();
	...
	$table.='<tr>
		<td style="border:1px solid #ccc;"colspan="4" rowspan="2">'.$sop.' <br />
	 '.$wi.'<br />
...
$table.='<table style="font-family:Arial, Helvetica, sans-serif;width:100%;font-size:8.5px !important; border: 1px solid #000000;	margin:0 auto;border-collapse:collapse;margin-top:10px;"  align="center">
    <colgroup>
        <col width="5%"><col width="5%">
        <col width="5%"><col width="5%">
        <col width="5%"><col width="5%">
