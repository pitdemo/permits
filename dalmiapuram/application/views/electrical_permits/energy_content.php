...
<DIV class="dclr"></DIV>
    ...
    <TR>
        ...
        <!-- swathi -->
        <TD colspan=4 class="border_right remove_border_right" ><input style="width:150px;" readonly  type="text" class="form-control" name="work_permit_nos" id="work_permit_nos" value="<?php echo (isset($records['work_permit_nos'])) ? $records['work_permit_nos'] : ''; ?>"  /></TD>
    </TR>
    ...
    <TR>
        ...
        <!-- swathi -->
        <TD colspan=3 class="tr8 td25 remove_border_right"><P style="text-align:center;">Isolation Type</P></TD>
    </TR>
        ...
        <TR>
            ...
            <!-- swathi -->
            <TD  colspan="3" class="tr10 td56 border_right remove_border_right">
    ...
    <table align="center" width="100%" border="1" class="equip_table">
    	<tr>
    		...
    		<td class="equip_table_label" colspan="2">PA Lock</td>
		...
		<tr>
			...
			$disabled='disabled="disabled"';
		?>
        <input type="text" class="form-control" name="isolated_equipment_tag_nos[<?php echo $i; ?>]" id="isolated_equipment_tag_nos[<?php echo $i; ?>]"  value="<?php echo $isolated_equipment_tag_no; ?>"  style="margin:2px;width:140px;" <?php  echo $disabled; ?>   /></td>
        <td> 		<?php 
	  ...
	  ?>
       ...
       ?>
        ...
        <td><select style="margin:5px;width:82px;"  id="isolated_equipment_descriptions[<?php echo $i; ?>]"  name="isolated_equipment_descriptions[<?php echo $i; ?>]" class="form-control isolated_equipment_descriptions" <?php  echo $disabled; ?>>
                                      <option value="">- Select-</option>
                                      <?php
	  if(count($isolations)>0)
	  {
	  ...
	  ?>
       ...
       ?>
		...
		<td><input type="text" class="form-control numinput" name="isolated_tagno1[<?php echo $i; ?>]" id="isolated_tagno1[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolated_tagno1->$i)) ? $isolated_tagno1->$i : ''; ?>" <?php  echo $disabled; ?>  style="margin:2px;width:72px;"  /></td>
		<td><input type="text" class="form-control numinput" name="isolated_tagno2[<?php echo $i; ?>]" id="isolated_tagno2[<?php echo $i; ?>]" 
            value="<?php echo (isset($isolated_tagno2->$i)) ? $isolated_tagno2->$i : ''; ?>" <?php  echo $disabled; ?>  style="margin:2px;width:72px;"  /></td>      
        <td><input type="text" class="form-control numinput" name="isolated_tagno3[<?php echo $i; ?>]" id="isolated_tagno3[<?php echo $i; ?>]" 
        ...
        <td> <input type="hidden" name="isolated_name_approval[<?php echo $i; ?>]" id="isolated_name_approval[<?php echo $i; ?>]" 
			...
			?>
			<td>
			<input type="text" disabled="disabled" name="isolated_name_approval_datetime[<?php echo $i; ?>]" id="isolated_name_approval_datetime[<?php echo $i; ?>]" value="<?php echo $isolated_name_approval_dttime; ?>" class="form-control" style="margin:10px;width:115px;font-size:11px;"  data-attr="<?php echo $i; ?>"  /></td> 
		</tr>
		<?php } ?>
    </table>		
