...
<div class="wrapper row-offcanvas row-offcanvas-left">
  ...
  width:245pt'><span style='mso-spacerun:yes'> </span><b>Hazards / concerns
                              Identified: <span style="float:right;"><b>YES/NO</b></span></b></td>
<!--                             <td class=xl86 width=108 style='border-top:none;border-left:none;width:55pt'><center>
                              <b>YES/NO</b>
                            </center></td>
 -->                            <td colspan=7 class=xl108 style='border-left:none;width:189pt'><b>Precautions to be Taken:</b></td>
              
                            <td class=xl89 style='width:82pt'><center>
                              <b>YES/NA</b>
                            </center></td>
...
?>                             
                             <td colspan=3 class=xl198 style='border-right:.5pt solid black;vertical-align:top;  width:245pt'>a) <input type="checkbox" name="hazards_options[a]" data-attr="a" <?php if(in_array('Electrical shock to the personal',$haz_options)) { ?> checked="checked" <?php } ?> value="Electrical shock to the personal" class="radio_button hazards_options" /> Electrical shock to the personal <input  data-attr="a" type="checkbox" name="hazards_options[a]" class="radio_button hazards_options" value="Electrocution" <?php if(in_array('Electrocution',$haz_options)) { ?> checked="checked" <?php } ?> /> Electrocution </td>
                            <td class=xl87 width=108 style='border-top:none;vertical-align:top;border-left:none;width:55pt'>
                            <center>
        ...
        <tr>
        <td style="width:335px !important;" class="table-inner-td">a) (i)Work area isolated by opening MCCB/ACB/SFU/VCB/AB Switch /MCB is isolated / Fuse removed locked and tagged <br />
        ...
        <center>
                ...
                <tr>
                <td class="table-inner-td">    ii) Ruber mat provided</td>
...
?>                              
                            ...
                            <td colspan=3 class=xl119 style='border-right:.5pt solid black;
  width:245pt'>b) <input type="checkbox" name="hazards_options[b]" data-attr="b" <?php if(in_array('Equipment Accidental Back Charge',$haz_options)) { ?> checked="checked" <?php } ?> value="Equipment Accidental Back Charge" class="radio_button hazards_options" /> Equipment Accidental Back Charge <input type="checkbox" name="hazards_options[b]" data-attr="b" <?php if(in_array('Interconnection available',$haz_options)) { ?> checked="checked" <?php } ?> value="Interconnection available" class="radio_button hazards_options" /> Interconnection available</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'>
                             <center> 
                                <input data-attr="b" name="hazards[b]" value="Yes" <?php if(isset($hazards->b) && $hazards->b=='Yes') { ?> checked="checked" <?php } ?> type="radio" class="radio_button hazards hazard_option" />
                                Y&nbsp;
                                <input data-attr="b" type="radio" <?php if(isset($hazards->b) && $hazards->b=='No') { ?> checked="checked" <?php } ?> name="hazards[b]" class="radio_button hazards hazard_option"  value="No"/>
                                N&nbsp;
                                </center>
                              </td>
        ...
        <td colspan=8 class=xl198 style='border-right:.5pt solid black; border-left:none;width:189pt;padding:0px !important;'>
          <table align="center" width="100%"  class="tr_heights" >
        <tr>
        <td  class="table-inner-td" style="width:335px !important;border-bottom:0px solid #000 !important;">b) All possible back feeding supplies are disconnected<br />
...
<?php
 ...
 ?>                    <tr style='mso-height-source:userset;height:52.5pt'>
              ...
              <b>Nature of Job:</b>&nbsp;                              
                              ...
                              <p><b>Is Energy Isolation permit obtained:</b></p>
...
<td colspan=8 class=xl198 style='border-right:.5pt solid black; border-left:none;width:189pt;padding:0px !important;'>
      <table align="center" width="100%"  class="tr_heights" >
        <tr>
        <td  class="table-inner-td" style="width:335px !important;border-bottom:1px solid #000 !important;">
...
?>                           
                            ...
                            <td colspan=3 class=xl115 style='width:245pt'>d) <input type="checkbox" name="hazards_options[d]" data-attr="d" <?php if(in_array('Electrical',$haz_options)) { ?> checked="checked" <?php } ?> value="Electrical" class="radio_button hazards_options" /> Electrical Fire while racking out <input type="checkbox" name="hazards_options[d]" data-attr="d" <?php if(in_array('breaker',$haz_options)) { ?> checked="checked" <?php } ?> value="breaker" class="radio_button hazards_options" /> in of breaker <input type="checkbox" name="hazards_options[d]" data-attr="d" <?php if(in_array('mcc',$haz_options)) { ?> checked="checked" <?php } ?> value="mcc" class="radio_button hazards_options" /> MCC Feeder Module</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'>

                             <center> 
                                <input data-attr="d" name="hazards[d]" value="Yes" <?php if(isset($hazards->d) && $hazards->d=='Yes') { ?> checked="checked" <?php } ?> type="radio" class="radio_button hazards" />
                                Y&nbsp;
                                <input data-attr="d" type="radio" <?php if(isset($hazards->d) && $hazards->d=='No') { ?> checked="checked" <?php } ?> name="hazards[d]" class="radio_button hazards"  value="No"/>
                                N&nbsp;
                                </center>
                              </td>
                              </td>
  ...
  height:45.75pt;width:300pt'>If Electrical works involved are at height, work at height permit no :                              
                ...
                if($height_works->num_rows()>0)
                {
                  ...
                  foreach($fet_height_works as $fet_height_work)
                  {
                    ...
                    if($height_work_id==$height_work_involved)
                    $chk="selected='selected'";                   
                    else
                    $chk='';
                    
                ?>
                   <option value="<?php echo $height_work_id; ?>" <?php echo $chk; ?>><?php echo strtoupper($height_work_location.' (#'.$height_work_no.')'); ?></option>
                               <?php
                  }
                }
                ?>
...
?>                  
  ...
  height:45.75pt;width:300pt'>
                            ...
                            <td colspan=3 class=xl166 style='border-right:.5pt solid black;
...
<tr height=21 style='height:15.75pt'>
  ...
  height:45.75pt;width:300pt'>
                            ...
                            <td colspan=4 valign="top" class=xl166 style='border-right:.5pt solid black; width:245pt;padding:0px !important;'> i) Others
  ...
  <td colspan=8 valign="top" class=xl198 style='border-right:.5pt solid black; border-left:none;width:335px;padding:0px !important;'> i) Others
...
?>
  ...
  border-left:none;width:124pt'><input type="text" value="<?php echo (isset($no_of_persons->a)) ? $no_of_persons->a : ''; ?>" name="no_of_persons[a]"  class="no_of_persons form-control numinput" style="width: 107px;" /></td>
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:126pt'><input type="text" value="<?php echo (isset($no_of_persons->b)) ? $no_of_persons->b : ''; ?>" name="no_of_persons[b]"  class="no_of_persons form-control numinput" style="width: 107px;" /></td>
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:117pt'><input type="text" value="<?php echo (isset($no_of_persons->c)) ? $no_of_persons->c : ''; ?>" name="no_of_persons[c]"  class="no_of_persons form-control numinput" style="width: 107px;" /></td>
                            <td colspan=2 class=xl179 style='border-right:1.0pt solid black;
  border-left:none;width:122pt'><input type="text" value="<?php echo (isset($no_of_persons->d)) ? $no_of_persons->d : ''; ?>" name="no_of_persons[d]"  class="no_of_persons form-control numinput" style="width: 107px;" /></td>
                            <td colspan=2 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:173pt'><input type="text" value="<?php echo (isset($no_of_persons->e)) ? $no_of_persons->e : ''; ?>" name="no_of_persons[e]"  class="no_of_persons form-control numinput" style="width: 107px;" /></td>
                            <td width="213" colspan=5 class=xl177 style='border-right:1.0pt solid black;
  border-left:none;width:163pt'><input type="text" value="<?php echo (isset($no_of_persons->f)) ? $no_of_persons->f : ''; ?>" name="no_of_persons[f]"  class="no_of_persons form-control numinput" style="width: 107px;" /></td>
                          </tr>
 <?php
     if(isset($records))
...
<select id="performing_authority[a]" name="performing_authority[a]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
...
<select id="performing_authority[c]" name="performing_authority[c]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
...
<select id="performing_authority[d]" name="performing_authority[d]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
  ...
  $validate.=",'self_cancellation_description':{required:function(element) {
    ...
    $("#job_form").validate({ 
      ...
      rules: {
       ...
       //delete 'other_inputs[]': {required:<?php echo $flag; ?>},
       //delete 'works[]': { required:<?php echo $flag; ?>,minlength:1},
