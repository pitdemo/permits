...
?>                              
  ...
  width:245pt'>b) <input type="checkbox" name="hazards_options[b]" data-attr="b" <?php if(in_array('Equipment Accidental Back Charge',$haz_options)) { ?> checked="checked" <?php } ?> value="Equipment Accidental Back Charge" class="radio_button hazards_options" /> Equipment Accidental Back Charge <input type="checkbox" name="hazards_options[b]" data-attr="b" <?php if(in_array('Interconnection available',$haz_options)) { ?> checked="checked" <?php } ?> value="Interconnection available" class="radio_button hazards_options" /> Interconnection available</td>
                            <td class=xl95 width=108 style='border-top:none;border-left:none;width:55pt'>
                             <center> 
                                <input data-attr="b" name="hazards[b]" value="Yes" <?php if(isset($hazards->b) && $hazards->b=='Yes') { ?> checked="checked" <?php } ?> type="radio" class="radio_button hazards" />
                                Y&nbsp;
...
?>                           
              ...
              <td colspan=4  class=xl120 style='height:52.5pt; width:300pt'>
              <b>Nature of Job:</b>&nbsp;                              
                              <input type="text"  name="job_name" id="job_name" class="form-control" style="width:400px;" value="<?php echo (isset($records['job_name'])) ? $records['job_name'] : ''; ?>"/></td>
...
<?php $height_work_involved=(isset($records['height_works_involved'])) ? $records['height_works_involved'] : ''; ?>
  ...
  height:45.75pt;width:300pt'>If Electrical works involved are at height, work at height permit no :                              
                                <select class="form-control select2-offscreen"  name="height_works_involved" id="height_works_involved" >
                                <option value="" selected>- - Select Height Work - -</option>
                              <?php
...
<tr height=21 style='height:15.75pt'>
  ...
  height:45.75pt;width:300pt'>
                            ...
                            <td colspan=4 class=xl166 style='border-right:.5pt solid black; width:245pt;padding:0px !important;'>
  ...
  <td colspan=8 class=xl198 style='border-right:.5pt solid black; border-left:none;width:335px;padding:0px !important;'>
...
<select id="performing_authority[e]" name="performing_authority[a]"  class="performing_authority form-control authority performing" style="width: 120px;">
                              <option value="" selected="selected">- - Select - -</option>
                              <?php
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('select#height_works_involved').select2();
