	...
	public function get_waiting_approval_name($array_args)
	{
		...
		switch($approval_status)
		{
			...
			case 8:
					...
					{	
						#$select=(isset($user_id_column->$r[$rr]) && $user_id_column->$r[$rr]!='') ? $user_id_column->$r[$rr] : '';
		...
		#echo 'AA '.is_numeric($user_id_column); exit;
		
		if($user_id_column!='' && is_numeric($user_id_column))
		{	
			...
			$first_name=isset($get_name) ? strtoupper($get_name['first_name']) : '- - -';
		}
		else
		$first_name='- - -';
