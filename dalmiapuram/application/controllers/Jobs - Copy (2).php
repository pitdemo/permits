...
class Jobs extends CI_Controller {
	...
	public function form_action()
	{
		...
		$array_fields=array('precautions_text','issuing_authority_approval_status','precautions_options','hazards_options','precautions','hazards','issuing_authority','no_of_persons','performing_authority','schedule_from_time','schedule_to_time','schedule_date','reference_code','extended_contractors_id','extended_others_contractors_id','hot_work_checklists','height_work_checklists','completion_checklist','extended_scaffolding_certification_no');
		...
		#echo '<br /> MSg : '.$msg.' - '.$show_button.' STATUS '.$status.' - '.$user_id.' = '.$msg_type; exit;
